...
public class Conditions {
	...
	public static ConditionTest getPostConditions(final Set<Condition> conditions) {
...
//						postConditions.addCondition(convertCondition((ContextFreeCondition) condition), condition);
	...
	public static ConditionTest getPreConditions(final Set<Condition> conditions) {
