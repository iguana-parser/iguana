...
//		assertTrue(grammarGraph.isLL1SubGrammar(D));
	...
	public void test2() {
		...
		TerminalNode node7 = factory.createTokenNode("epsilon", 0, 0);
		node6.addChild(node7);
		node5.addChild(node6);
		...
		node4.addChild(node8);
		node3.addChild(node4);
		TerminalNode node10 = factory.createTokenNode("a", 0, 1);
		node2.addChild(node3);
	...
	public void test3() {
		...
		TerminalNode node10 = factory.createTokenNode("epsilon", 1, 0);
		node9.addChild(node10);
		node8.addChild(node9);
		node4.addChild(node5);
		node4.addChild(node8);
		node3.addChild(node4);
		TerminalNode node11 = factory.createTokenNode("a", 1, 1);
		node2.addChild(node3);
		node2.addChild(node11);
		node1.addChild(node2);
	...
	public void test4() {
		...
		TerminalNode node10 = factory.createTokenNode("d", 0, 1);
		node9.addChild(node10);
		node8.addChild(node9);
		node4.addChild(node5);
		node4.addChild(node8);
