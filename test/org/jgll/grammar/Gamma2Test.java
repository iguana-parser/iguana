...
public class Gamma2Test {
	...
	private SPPFNode getSPPF1() {
		...
		NonterminalSymbolNode node4 = new NonterminalSymbolNode(grammar.getHeadGrammarSlot("S"), 0, 1);
		TokenSymbolNode node5 = new TokenSymbolNode(2, 0, 1);
		node4.addChild(node5);
		NonterminalSymbolNode node6 = new NonterminalSymbolNode(grammar.getHeadGrammarSlot("S"), 1, 2);
		...
		NonterminalSymbolNode node11 = new NonterminalSymbolNode(grammar.getHeadGrammarSlot("S"), 0, 2);
		...
		NonterminalSymbolNode node13 = new NonterminalSymbolNode(grammar.getHeadGrammarSlot("S"), 1, 3);
	...
	private SPPFNode getSPPF2() {
		NonterminalSymbolNode node1 = new NonterminalSymbolNode(grammar.getHeadGrammarSlot("S"), 0, 4);
		PackedNode node2 = new PackedNode(grammar.getGrammarSlotByName("S ::= S S ."), 1, node1);
		NonterminalSymbolNode node3 = new NonterminalSymbolNode(grammar.getHeadGrammarSlot("S"), 0, 1);
		TokenSymbolNode node4 = new TokenSymbolNode(2, 0, 1);
		node3.addChild(node4);
		NonterminalSymbolNode node5 = new NonterminalSymbolNode(grammar.getHeadGrammarSlot("S"), 1, 4);
		PackedNode node6 = new PackedNode(grammar.getGrammarSlotByName("S ::= S S ."), 3, node5);
		NonterminalSymbolNode node7 = new NonterminalSymbolNode(grammar.getHeadGrammarSlot("S"), 1, 3);
		NonterminalSymbolNode node8 = new NonterminalSymbolNode(grammar.getHeadGrammarSlot("S"), 1, 2);
		TokenSymbolNode node9 = new TokenSymbolNode(2, 1, 1);
		node8.addChild(node9);
		NonterminalSymbolNode node10 = new NonterminalSymbolNode(grammar.getHeadGrammarSlot("S"), 2, 3);
		TokenSymbolNode node11 = new TokenSymbolNode(2, 2, 1);
		node10.addChild(node11);
		node7.addChild(node8);
		node7.addChild(node10);
		NonterminalSymbolNode node12 = new NonterminalSymbolNode(grammar.getHeadGrammarSlot("S"), 3, 4);
		...
		NonterminalSymbolNode node15 = new NonterminalSymbolNode(grammar.getHeadGrammarSlot("S"), 2, 4);
		...
		NonterminalSymbolNode node19 = new NonterminalSymbolNode(grammar.getHeadGrammarSlot("S"), 0, 3);
		...
		NonterminalSymbolNode node22 = new NonterminalSymbolNode(grammar.getHeadGrammarSlot("S"), 0, 2);
	...
	private SPPFNode getSPPF3() {
		...
		NonterminalSymbolNode node5 = new NonterminalSymbolNode(grammar.getHeadGrammarSlot("S"), 0, 3);
		...
		NonterminalSymbolNode node8 = new NonterminalSymbolNode(grammar.getHeadGrammarSlot("S"), 0, 1);
		TokenSymbolNode node9 = new TokenSymbolNode(2, 0, 1);
		node8.addChild(node9);
		NonterminalSymbolNode node10 = new NonterminalSymbolNode(grammar.getHeadGrammarSlot("S"), 1, 2);
		TokenSymbolNode node11 = new TokenSymbolNode(2, 1, 1);
		node10.addChild(node11);
		node7.addChild(node8);
		node7.addChild(node10);
		NonterminalSymbolNode node12 = new NonterminalSymbolNode(grammar.getHeadGrammarSlot("S"), 2, 3);
		TokenSymbolNode node13 = new TokenSymbolNode(2, 2, 1);
		node12.addChild(node13);
		node6.addChild(node7);
		node6.addChild(node12);
		PackedNode node14 = new PackedNode(grammar.getGrammarSlotByName("S ::= S S ."), 2, node5);
		NonterminalSymbolNode node15 = new NonterminalSymbolNode(grammar.getHeadGrammarSlot("S"), 0, 2);
		node15.addChild(node8);
		node15.addChild(node10);
		node14.addChild(node15);
		node14.addChild(node12);
		PackedNode node16 = new PackedNode(grammar.getGrammarSlotByName("S ::= S S ."), 1, node5);
		NonterminalSymbolNode node17 = new NonterminalSymbolNode(grammar.getHeadGrammarSlot("S"), 1, 3);
		node17.addChild(node10);
		...
		node5.addChild(node14);
		node5.addChild(node16);
		NonterminalSymbolNode node18 = new NonterminalSymbolNode(grammar.getHeadGrammarSlot("S"), 3, 4);
		...
		NonterminalSymbolNode node21 = new NonterminalSymbolNode(grammar.getHeadGrammarSlot("S"), 1, 4);
		...
		NonterminalSymbolNode node26 = new NonterminalSymbolNode(grammar.getHeadGrammarSlot("S"), 2, 4);
		node26.addChild(node12);
		...
		NonterminalSymbolNode node28 = new NonterminalSymbolNode(grammar.getHeadGrammarSlot("S"), 4, 5);
		...
		NonterminalSymbolNode node31 = new NonterminalSymbolNode(grammar.getHeadGrammarSlot("S"), 0, 4);
		...
		NonterminalSymbolNode node41 = new NonterminalSymbolNode(grammar.getHeadGrammarSlot("S"), 1, 5);
		...
		NonterminalSymbolNode node48 = new NonterminalSymbolNode(grammar.getHeadGrammarSlot("S"), 2, 5);
		...
		NonterminalSymbolNode node53 = new NonterminalSymbolNode(grammar.getHeadGrammarSlot("S"), 3, 5);
