...
public class JavaCharacterLevel {
	...
	public static Grammar grammar = 
			...
			//empty() ::= 
			.addRule(Rule.withHead(Nonterminal.builder("empty()").build()).setLayout(Nonterminal.builder("Layout").build()).build())
			...
			.addRule(Rule.withHead(Nonterminal.builder("start[CompilationUnit]").build()).addSymbol(Nonterminal.builder("CompilationUnit").setLabel("top").build()).setLayout(Nonterminal.builder("Layout").build()).build())
