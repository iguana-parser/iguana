...
public class GrammarTest {
	...
	public void gamma2FirstAndFollowSets() {
		...
		assertEquals(set(new Character('a'), new Character('d')), gamma2.getNonterminalByName("A").getFollowSet());
		assertEquals(set(new Character('d')), gamma2.getNonterminalByName("S").getFollowSet());
	}
