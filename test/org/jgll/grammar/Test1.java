...
public class Test1 {
	...
	public static Grammar grammar =
			...
			private static List<PrecedencePattern> precedencePatterns1() {
			  ...
			  // (E, . E (*) E, E (+) E)
			     new PrecedencePattern(Nonterminal.builder("E").build(), Arrays.asList(Nonterminal.builder("E").build(), Terminal.builder(Sequence.builder(Character.builder(42).build()).build()).build(), Nonterminal.builder("E").build()), 0, Arrays.asList(Nonterminal.builder("E").build(), Terminal.builder(Sequence.builder(Character.builder(43).build()).build()).build(), Nonterminal.builder("E").build())), 
			  // (E, (-) . E, E (*) E)
			     new PrecedencePattern(Nonterminal.builder("E").build(), Arrays.asList(Terminal.builder(Sequence.builder(Character.builder(45).build()).build()).build(), Nonterminal.builder("E").build()), 1, Arrays.asList(Nonterminal.builder("E").build(), Terminal.builder(Sequence.builder(Character.builder(42).build()).build()).build(), Nonterminal.builder("E").build())), 
			  // (E, (-) . E, E (+) E)
			     new PrecedencePattern(Nonterminal.builder("E").build(), Arrays.asList(Terminal.builder(Sequence.builder(Character.builder(45).build()).build()).build(), Nonterminal.builder("E").build()), 1, Arrays.asList(Nonterminal.builder("E").build(), Terminal.builder(Sequence.builder(Character.builder(43).build()).build()).build(), Nonterminal.builder("E").build())), 
			  // (E, E (+) . E, E (+) E)
			     new PrecedencePattern(Nonterminal.builder("E").build(), Arrays.asList(Nonterminal.builder("E").build(), Terminal.builder(Sequence.builder(Character.builder(43).build()).build()).build(), Nonterminal.builder("E").build()), 2, Arrays.asList(Nonterminal.builder("E").build(), Terminal.builder(Sequence.builder(Character.builder(43).build()).build()).build(), Nonterminal.builder("E").build())), 
			  // (E, E (*) . E, E (*) E)
			     new PrecedencePattern(Nonterminal.builder("E").build(), Arrays.asList(Nonterminal.builder("E").build(), Terminal.builder(Sequence.builder(Character.builder(42).build()).build()).build(), Nonterminal.builder("E").build()), 2, Arrays.asList(Nonterminal.builder("E").build(), Terminal.builder(Sequence.builder(Character.builder(42).build()).build()).build(), Nonterminal.builder("E").build())), 
			  // (E, E (*) . E, E (+) E)
			     new PrecedencePattern(Nonterminal.builder("E").build(), Arrays.asList(Nonterminal.builder("E").build(), Terminal.builder(Sequence.builder(Character.builder(42).build()).build()).build(), Nonterminal.builder("E").build()), 2, Arrays.asList(Nonterminal.builder("E").build(), Terminal.builder(Sequence.builder(Character.builder(43).build()).build()).build(), Nonterminal.builder("E").build())) 
			);
			}
