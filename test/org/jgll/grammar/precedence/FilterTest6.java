...
public class FilterTest6 {
	...
	private SPPFNode getSPPF() {
		...
		NonterminalSymbolNode node3 = new NonterminalSymbolNode(grammar.getHeadGrammarSlot("E"), 0, 3);
		IntermediateNode node4 = new IntermediateNode(grammar.getGrammarSlotByName("E4 ::= E4 [+] . E2"), 0, 2);
		NonterminalSymbolNode node5 = new NonterminalSymbolNode(grammar.getHeadGrammarSlot("E"), 0, 1);
		...
		NonterminalSymbolNode node11 = new NonterminalSymbolNode(grammar.getHeadGrammarSlot("E"), 4, 17);
		...
		NonterminalSymbolNode node15 = new NonterminalSymbolNode(grammar.getHeadGrammarSlot("E"), 5, 6);
		...
		NonterminalSymbolNode node18 = new NonterminalSymbolNode(grammar.getHeadGrammarSlot("E"), 7, 17);
		...
		NonterminalSymbolNode node22 = new NonterminalSymbolNode(grammar.getHeadGrammarSlot("E"), 8, 15);
		IntermediateNode node23 = new IntermediateNode(grammar.getGrammarSlotByName("E4 ::= E4 [-] . E2"), 8, 14);
		NonterminalSymbolNode node24 = new NonterminalSymbolNode(grammar.getHeadGrammarSlot("E"), 8, 13);
		IntermediateNode node25 = new IntermediateNode(grammar.getGrammarSlotByName("E4 ::= E4 [-] . E2"), 8, 12);
		NonterminalSymbolNode node26 = new NonterminalSymbolNode(grammar.getHeadGrammarSlot("E"), 8, 11);
		...
		NonterminalSymbolNode node31 = new NonterminalSymbolNode(grammar.getHeadGrammarSlot("E"), 10, 11);
		...
		NonterminalSymbolNode node34 = new NonterminalSymbolNode(grammar.getHeadGrammarSlot("E"), 12, 13);
		...
		NonterminalSymbolNode node37 = new NonterminalSymbolNode(grammar.getHeadGrammarSlot("E"), 14, 15);
		...
		NonterminalSymbolNode node40 = new NonterminalSymbolNode(grammar.getHeadGrammarSlot("E"), 16, 17);
