...
public class FilterTest3 {
	...
	private NonterminalSymbolNode getSPPF() {
		...
		NonterminalSymbolNode node6 = new NonterminalSymbolNode(grammar.getHeadGrammarSlot("E"), 0, 1);
		TokenSymbolNode node7 = new TokenSymbolNode(3, 0, 1);
		node6.addChild(node7);
		ListSymbolNode node8 = new ListSymbolNode(grammar.getHeadGrammarSlot("E+"), 1, 3);
		...
		NonterminalSymbolNode node15 = new NonterminalSymbolNode(grammar.getHeadGrammarSlot("E"), 4, 9);
		NonterminalSymbolNode node16 = new NonterminalSymbolNode(grammar.getHeadGrammarSlot("E"), 4, 5);
		TokenSymbolNode node17 = new TokenSymbolNode(3, 4, 1);
		node16.addChild(node17);
		ListSymbolNode node18 = new ListSymbolNode(grammar.getHeadGrammarSlot("E+"), 5, 9);
		...
		NonterminalSymbolNode node22 = new NonterminalSymbolNode(grammar.getHeadGrammarSlot("E"), 5, 6);
		TokenSymbolNode node23 = new TokenSymbolNode(3, 5, 1);
		node22.addChild(node23);
		node21.addChild(node22);
		NonterminalSymbolNode node24 = new NonterminalSymbolNode(grammar.getHeadGrammarSlot("E"), 6, 7);
		TokenSymbolNode node25 = new TokenSymbolNode(3, 6, 1);
		node24.addChild(node25);
		node20.addChild(node21);
		node20.addChild(node24);
		NonterminalSymbolNode node26 = new NonterminalSymbolNode(grammar.getHeadGrammarSlot("E"), 7, 8);
		TokenSymbolNode node27 = new TokenSymbolNode(3, 7, 1);
		node26.addChild(node27);
		node19.addChild(node20);
		node19.addChild(node26);
		NonterminalSymbolNode node28 = new NonterminalSymbolNode(grammar.getHeadGrammarSlot("E"), 8, 9);
		...
		NonterminalSymbolNode node31 = new NonterminalSymbolNode(grammar.getHeadGrammarSlot("E"), 10, 14);
		NonterminalSymbolNode node32 = new NonterminalSymbolNode(grammar.getHeadGrammarSlot("E"), 10, 11);
		TokenSymbolNode node33 = new TokenSymbolNode(3, 10, 1);
		node32.addChild(node33);
		ListSymbolNode node34 = new ListSymbolNode(grammar.getHeadGrammarSlot("E+"), 11, 14);
		...
		NonterminalSymbolNode node37 = new NonterminalSymbolNode(grammar.getHeadGrammarSlot("E"), 11, 12);
		TokenSymbolNode node38 = new TokenSymbolNode(3, 11, 1);
		node37.addChild(node38);
		node36.addChild(node37);
		NonterminalSymbolNode node39 = new NonterminalSymbolNode(grammar.getHeadGrammarSlot("E"), 12, 13);
		TokenSymbolNode node40 = new TokenSymbolNode(3, 12, 1);
		node39.addChild(node40);
		node35.addChild(node36);
		node35.addChild(node39);
		NonterminalSymbolNode node41 = new NonterminalSymbolNode(grammar.getHeadGrammarSlot("E"), 13, 14);
