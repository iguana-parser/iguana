...
public class FilterTest7 {
	...
	private NonterminalSymbolNode getSPPF() {
		NonterminalSymbolNode node1 = new NonterminalSymbolNode(grammar.getHeadGrammarSlot("E"), 0, 13);
		IntermediateNode node2 = new IntermediateNode(grammar.getGrammarSlotByName("E ::= E [+] . E2"), 0, 9);
		NonterminalSymbolNode node3 = new NonterminalSymbolNode(grammar.getHeadGrammarSlot("E"), 0, 8);
		...
		ListSymbolNode node6 = new ListSymbolNode(grammar.getHeadGrammarSlot("E+"), 0, 2);
		ListSymbolNode node7 = new ListSymbolNode(grammar.getHeadGrammarSlot("E+"), 0, 1);
		NonterminalSymbolNode node8 = new NonterminalSymbolNode(grammar.getHeadGrammarSlot("E"), 0, 1);
		TokenSymbolNode node9 = new TokenSymbolNode(3, 0, 1);
		node8.addChild(node9);
		node7.addChild(node8);
		NonterminalSymbolNode node10 = new NonterminalSymbolNode(grammar.getHeadGrammarSlot("E"), 1, 2);
		TokenSymbolNode node11 = new TokenSymbolNode(3, 1, 1);
		node10.addChild(node11);
		node6.addChild(node7);
		node6.addChild(node10);
		NonterminalSymbolNode node12 = new NonterminalSymbolNode(grammar.getHeadGrammarSlot("E"), 2, 3);
		...
		NonterminalSymbolNode node15 = new NonterminalSymbolNode(grammar.getHeadGrammarSlot("E"), 4, 8);
		ListSymbolNode node16 = new ListSymbolNode(grammar.getHeadGrammarSlot("E+"), 4, 7);
		ListSymbolNode node17 = new ListSymbolNode(grammar.getHeadGrammarSlot("E+"), 4, 6);
		ListSymbolNode node18 = new ListSymbolNode(grammar.getHeadGrammarSlot("E+"), 4, 5);
		NonterminalSymbolNode node19 = new NonterminalSymbolNode(grammar.getHeadGrammarSlot("E"), 4, 5);
		TokenSymbolNode node20 = new TokenSymbolNode(3, 4, 1);
		node19.addChild(node20);
		node18.addChild(node19);
		NonterminalSymbolNode node21 = new NonterminalSymbolNode(grammar.getHeadGrammarSlot("E"), 5, 6);
		TokenSymbolNode node22 = new TokenSymbolNode(3, 5, 1);
		node21.addChild(node22);
		node17.addChild(node18);
		node17.addChild(node21);
		NonterminalSymbolNode node23 = new NonterminalSymbolNode(grammar.getHeadGrammarSlot("E"), 6, 7);
		TokenSymbolNode node24 = new TokenSymbolNode(3, 6, 1);
		node23.addChild(node24);
		node16.addChild(node17);
		node16.addChild(node23);
		NonterminalSymbolNode node25 = new NonterminalSymbolNode(grammar.getHeadGrammarSlot("E"), 7, 8);
		...
		NonterminalSymbolNode node28 = new NonterminalSymbolNode(grammar.getHeadGrammarSlot("E"), 9, 13);
		ListSymbolNode node29 = new ListSymbolNode(grammar.getHeadGrammarSlot("E+"), 9, 12);
		ListSymbolNode node30 = new ListSymbolNode(grammar.getHeadGrammarSlot("E+"), 9, 11);
		ListSymbolNode node31 = new ListSymbolNode(grammar.getHeadGrammarSlot("E+"), 9, 10);
		NonterminalSymbolNode node32 = new NonterminalSymbolNode(grammar.getHeadGrammarSlot("E"), 9, 10);
		TokenSymbolNode node33 = new TokenSymbolNode(3, 9, 1);
		node32.addChild(node33);
		node31.addChild(node32);
		NonterminalSymbolNode node34 = new NonterminalSymbolNode(grammar.getHeadGrammarSlot("E"), 10, 11);
		TokenSymbolNode node35 = new TokenSymbolNode(3, 10, 1);
		node34.addChild(node35);
		node30.addChild(node31);
		node30.addChild(node34);
		NonterminalSymbolNode node36 = new NonterminalSymbolNode(grammar.getHeadGrammarSlot("E"), 11, 12);
		TokenSymbolNode node37 = new TokenSymbolNode(3, 11, 1);
		node36.addChild(node37);
		node29.addChild(node30);
		node29.addChild(node36);
		NonterminalSymbolNode node38 = new NonterminalSymbolNode(grammar.getHeadGrammarSlot("E"), 12, 13);
