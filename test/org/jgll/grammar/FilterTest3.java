...
public class FilterTest3 {
	...
	private NonterminalSymbolNode getSPPF() {
		...
		IntermediateNode node2 = new IntermediateNode(grammar.getGrammarSlotByName("E ::= E [+] . E3"), 0, 10);
		...
		NonterminalSymbolNode node6 = new NonterminalSymbolNode(grammar.getNonterminalByNameAndIndex("E", 2), 0, 1);
		...
		NonterminalSymbolNode node15 = new NonterminalSymbolNode(grammar.getNonterminalByNameAndIndex("E", 3), 4, 9);
		NonterminalSymbolNode node16 = new NonterminalSymbolNode(grammar.getNonterminalByNameAndIndex("E", 2), 4, 5);
		...
		NonterminalSymbolNode node28 = new NonterminalSymbolNode(grammar.getNonterminalByNameAndIndex("E", 2), 8, 9);
		...
		NonterminalSymbolNode node31 = new NonterminalSymbolNode(grammar.getNonterminalByNameAndIndex("E", 3), 10, 14);
		NonterminalSymbolNode node32 = new NonterminalSymbolNode(grammar.getNonterminalByNameAndIndex("E", 2), 10, 11);
		...
		NonterminalSymbolNode node41 = new NonterminalSymbolNode(grammar.getNonterminalByNameAndIndex("E", 2), 13, 14);
