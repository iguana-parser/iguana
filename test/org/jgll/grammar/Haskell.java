...
public class Haskell {
	...
	public static Grammar grammar =	
		...
		.addRule(Rule.withHead(Nonterminal.builder("NComment").build()).addSymbol(Nonterminal.builder("OpenCom").build()).addSymbol(Star.builder(Nonterminal.builder("ANY").build()).build()).addSymbol(Star.builder(Sequence.builder(Nonterminal.builder("NComment").build(), Nonterminal.builder("ANY").build()).build()).build()).addSymbol(Nonterminal.builder("CloseCom").build()).setLayoutStrategy(NO_LAYOUT).build())
		// TyCls ::= ConId 
		...
		// OpenCom ::= ({ -) 
		.addRule(Rule.withHead(Nonterminal.builder("OpenCom").build()).addSymbol(Terminal.builder(Sequence.builder(Character.builder(123).build(), Character.builder(45).build()).build()).build()).setLayoutStrategy(NO_LAYOUT).build())
		// Decimal ::= Digit Digit* 
		...
		.addRule(Rule.withHead(Nonterminal.builder("ANY").build()).addSymbol(Alt.builder(Nonterminal.builder("WhiteChar").build(), Nonterminal.builder("Graphic").build()).addPostConditions(Sets.newHashSet(new RegularExpressionCondition(ConditionType.NOT_MATCH, Alt.builder(Terminal.builder(Sequence.builder(Character.builder(123).build(), Character.builder(45).build()).build()).build(), Terminal.builder(Sequence.builder(Character.builder(45).build(), Character.builder(125).build()).build()).build()).build()))).build()).setLayoutStrategy(NO_LAYOUT).build())
		// QTyCon ::= (ModId (.))? TyCon 
		...
		// CloseCom ::= (- }) 
		.addRule(Rule.withHead(Nonterminal.builder("CloseCom").build()).addSymbol(Terminal.builder(Sequence.builder(Character.builder(45).build(), Character.builder(125).build()).build()).build()).setLayoutStrategy(NO_LAYOUT).build())
		...
		.addRule(Rule.withHead(Nonterminal.builder("Whitespace").build()).addSymbol(Star.builder(Nonterminal.builder("WhiteStuff").build()).addPostConditions(Sets.newHashSet(new RegularExpressionCondition(ConditionType.NOT_FOLLOW, Terminal.builder(Sequence.builder(Character.builder(123).build(), Character.builder(45).build()).build()).build()), new RegularExpressionCondition(ConditionType.NOT_FOLLOW, Alt.builder(CharacterRange.builder(9, 11).build(), CharacterRange.builder(13, 13).build(), CharacterRange.builder(32, 32).build()).build()), new RegularExpressionCondition(ConditionType.NOT_FOLLOW, Terminal.builder(Sequence.builder(Character.builder(45).build(), Character.builder(45).build()).build()).build()))).build()).setLayoutStrategy(NO_LAYOUT).build())
		// FBind ::= QVar (=) Exp 
