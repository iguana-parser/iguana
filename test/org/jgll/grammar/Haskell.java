...
public class Haskell {
	...
	public static Grammar grammar =
		...
		// GADTDecl ::= TyCon (: :) ({) (Var ((: :) Type)?)+ (}) (- >) Type 
		.addRule(Rule.withHead(Nonterminal.builder("GADTDecl").build()).addSymbol(Nonterminal.builder("TyCon").build()).addSymbol(Terminal.builder(Sequence.builder(Character.builder(58).build(), Character.builder(58).build()).build()).build()).addSymbol(Terminal.builder(Sequence.builder(Character.builder(123).build()).build()).build()).addSymbol(Plus.builder(Sequence.builder(Nonterminal.builder("Var").build(), org.jgll.regex.Opt.builder(Sequence.builder(Terminal.builder(Sequence.builder(Character.builder(58).build(), Character.builder(58).build()).build()).build(), Nonterminal.builder("Type").build()).build()).build()).build()).addSeparators(Arrays.asList(Terminal.builder(Sequence.builder(Character.builder(44).build()).build()).build())).build()).addSymbol(Terminal.builder(Sequence.builder(Character.builder(125).build()).build()).build()).addSymbol(Terminal.builder(Sequence.builder(Character.builder(45).build(), Character.builder(62).build()).build()).build()).addSymbol(Nonterminal.builder("Type").build()).build())
		// GADTDecl ::= TyCon (: :) Type 
		.addRule(Rule.withHead(Nonterminal.builder("GADTDecl").build()).addSymbol(Nonterminal.builder("TyCon").build()).addSymbol(Terminal.builder(Sequence.builder(Character.builder(58).build(), Character.builder(58).build()).build()).build()).addSymbol(Nonterminal.builder("Type").build()).build())
		// Guards ::= (|) Guard+ 
		...
		// FieldDecl ::= Vars (: :) Type 
		.addRule(Rule.withHead(Nonterminal.builder("FieldDecl").build()).addSymbol(Nonterminal.builder("Vars").build()).addSymbol(Terminal.builder(Sequence.builder(Character.builder(58).build(), Character.builder(58).build()).build()).build()).addSymbol(Nonterminal.builder("Type").build()).build())
		// GTyCon ::= QTyCon 
		...
		// Context ::= Forall? (() Class* ()) 
		.addRule(Rule.withHead(Nonterminal.builder("Context").build()).addSymbol(org.jgll.regex.Opt.builder(Nonterminal.builder("Forall").build()).build()).addSymbol(Terminal.builder(Sequence.builder(Character.builder(40).build()).build()).build()).addSymbol(Star.builder(Nonterminal.builder("Class").build()).addSeparators(Arrays.asList(Terminal.builder(Sequence.builder(Character.builder(44).build()).build()).build())).build()).addSymbol(Terminal.builder(Sequence.builder(Character.builder(41).build()).build()).build()).build())
		// Context ::= Forall? Class 
		.addRule(Rule.withHead(Nonterminal.builder("Context").build()).addSymbol(org.jgll.regex.Opt.builder(Nonterminal.builder("Forall").build()).build()).addSymbol(Nonterminal.builder("Class").build()).build())
		// Large ::= AscLarge 
		...
		// Type ::= Forall? BType ((- >) Type)? 
		.addRule(Rule.withHead(Nonterminal.builder("Type").build()).addSymbol(org.jgll.regex.Opt.builder(Nonterminal.builder("Forall").build()).build()).addSymbol(Nonterminal.builder("BType").build()).addSymbol(org.jgll.regex.Opt.builder(Sequence.builder(Terminal.builder(Sequence.builder(Character.builder(45).build(), Character.builder(62).build()).build()).build(), Nonterminal.builder("Type").build()).build()).build()).build())
		// Alt ::= 
		...
		// AExp ::= (() (#) Exp (,) Exp+ (#) ()) 
		.addRule(Rule.withHead(Nonterminal.builder("AExp").build()).addSymbol(Terminal.builder(Sequence.builder(Character.builder(40).build()).build()).build()).addSymbol(Terminal.builder(Sequence.builder(Character.builder(35).build()).build()).build()).addSymbol(Nonterminal.builder("Exp").build()).addSymbol(Terminal.builder(Sequence.builder(Character.builder(44).build()).build()).build()).addSymbol(Plus.builder(Nonterminal.builder("Exp").build()).addSeparators(Arrays.asList(Terminal.builder(Sequence.builder(Character.builder(44).build()).build()).build())).build()).addSymbol(Terminal.builder(Sequence.builder(Character.builder(35).build()).build()).build()).addSymbol(Terminal.builder(Sequence.builder(Character.builder(41).build()).build()).build()).build())
		...
		// LExp ::= (\) APat+ (- >) InfixExp 
		.addRule(Rule.withHead(Nonterminal.builder("LExp").build()).addSymbol(Terminal.builder(Sequence.builder(Character.builder(92).build()).build()).build()).addSymbol(Plus.builder(Nonterminal.builder("APat").build()).build()).addSymbol(Terminal.builder(Sequence.builder(Character.builder(45).build(), Character.builder(62).build()).build()).build()).addSymbol(Nonterminal.builder("InfixExp").build()).build())
		// GADTDecls ::= ({) GADTDecl+ (}) 
		...
		// Forall ::= (f o r a l l) Var+ (.) 
		.addRule(Rule.withHead(Nonterminal.builder("Forall").build()).addSymbol(Terminal.builder(Sequence.builder(Character.builder(102).build(), Character.builder(111).build(), Character.builder(114).build(), Character.builder(97).build(), Character.builder(108).build(), Character.builder(108).build()).build()).build()).addSymbol(Plus.builder(Nonterminal.builder("Var").build()).build()).addSymbol(Terminal.builder(Sequence.builder(Character.builder(46).build()).build()).build()).build())
		// Ascii ::= (E T X) 
		...
		// AType ::= (() (#) Type (,) Type+ (#) ()) 
		.addRule(Rule.withHead(Nonterminal.builder("AType").build()).addSymbol(Terminal.builder(Sequence.builder(Character.builder(40).build()).build()).build()).addSymbol(Terminal.builder(Sequence.builder(Character.builder(35).build()).build()).build()).addSymbol(Nonterminal.builder("Type").build()).addSymbol(Terminal.builder(Sequence.builder(Character.builder(44).build()).build()).build()).addSymbol(Plus.builder(Nonterminal.builder("Type").build()).addSeparators(Arrays.asList(Terminal.builder(Sequence.builder(Character.builder(44).build()).build()).build())).build()).addSymbol(Terminal.builder(Sequence.builder(Character.builder(35).build()).build()).build()).addSymbol(Terminal.builder(Sequence.builder(Character.builder(41).build()).build()).build()).build())
		// AType ::= ([) Type (]) 
		...
		// APat ::= (() (#) Pat (,) Pat+ (#) ()) 
		.addRule(Rule.withHead(Nonterminal.builder("APat").build()).addSymbol(Terminal.builder(Sequence.builder(Character.builder(40).build()).build()).build()).addSymbol(Terminal.builder(Sequence.builder(Character.builder(35).build()).build()).build()).addSymbol(Nonterminal.builder("Pat").build()).addSymbol(Terminal.builder(Sequence.builder(Character.builder(44).build()).build()).build()).addSymbol(Plus.builder(Nonterminal.builder("Pat").build()).addSeparators(Arrays.asList(Terminal.builder(Sequence.builder(Character.builder(44).build()).build()).build())).build()).addSymbol(Terminal.builder(Sequence.builder(Character.builder(35).build()).build()).build()).addSymbol(Terminal.builder(Sequence.builder(Character.builder(41).build()).build()).build()).build())
		// APat ::= QCon ({) FPat* (}) 
		...
		// Literal ::= Integer (#)? 
		.addRule(Rule.withHead(Nonterminal.builder("Literal").build()).addSymbol(Nonterminal.builder("Integer").build()).addSymbol(org.jgll.regex.Opt.builder(Terminal.builder(Sequence.builder(Character.builder(35).build()).build()).build()).build()).setLayoutStrategy(NO_LAYOUT).build())
		// Literal ::= Char (#)? 
		.addRule(Rule.withHead(Nonterminal.builder("Literal").build()).addSymbol(Nonterminal.builder("Char").build()).addSymbol(org.jgll.regex.Opt.builder(Terminal.builder(Sequence.builder(Character.builder(35).build()).build()).build()).build()).setLayoutStrategy(NO_LAYOUT).build())
		// Literal ::= Float (#)? 
		.addRule(Rule.withHead(Nonterminal.builder("Literal").build()).addSymbol(Nonterminal.builder("Float").build()).addSymbol(org.jgll.regex.Opt.builder(Terminal.builder(Sequence.builder(Character.builder(35).build()).build()).build()).build()).setLayoutStrategy(NO_LAYOUT).build())
		// Literal ::= String (#)? 
		.addRule(Rule.withHead(Nonterminal.builder("Literal").build()).addSymbol(Nonterminal.builder("String").build()).addSymbol(org.jgll.regex.Opt.builder(Terminal.builder(Sequence.builder(Character.builder(35).build()).build()).build()).build()).setLayoutStrategy(NO_LAYOUT).build())
		// VarSym ::= (Symbol Symbol*) 
		.addRule(Rule.withHead(Nonterminal.builder("VarSym").build()).addSymbol(Sequence.builder(Nonterminal.builder("Symbol").addPostConditions(Sets.newHashSet(new RegularExpressionCondition(ConditionType.NOT_MATCH, Alt.builder(Terminal.builder(Sequence.builder(Character.builder(58).build()).build()).build()).build()))).build(), Star.builder(Nonterminal.builder("Symbol").build()).build()).addPostConditions(Sets.newHashSet(new RegularExpressionCondition(ConditionType.NOT_FOLLOW, Alt.builder(CharacterRange.builder(33, 33).build(), CharacterRange.builder(35, 38).build(), CharacterRange.builder(42, 43).build(), CharacterRange.builder(45, 45).build(), CharacterRange.builder(47, 47).build(), CharacterRange.builder(58, 58).build(), CharacterRange.builder(60, 64).build(), CharacterRange.builder(92, 92).build(), CharacterRange.builder(94, 94).build(), CharacterRange.builder(124, 124).build(), CharacterRange.builder(126, 126).build(), CharacterRange.builder(8902, 8902).build()).build()), new RegularExpressionCondition(ConditionType.NOT_MATCH, Alt.builder(Terminal.builder(Sequence.builder(Character.builder(58).build()).build()).build(), Terminal.builder(Sequence.builder(Character.builder(61).build()).build()).build(), Terminal.builder(Sequence.builder(Character.builder(61).build(), Character.builder(62).build()).build()).build(), Terminal.builder(Sequence.builder(Character.builder(126).build()).build()).build(), Terminal.builder(Sequence.builder(Character.builder(92).build()).build()).build(), Terminal.builder(Sequence.builder(Character.builder(124).build()).build()).build(), Terminal.builder(Sequence.builder(Character.builder(60).build(), Character.builder(45).build()).build()).build(), Terminal.builder(Sequence.builder(Character.builder(45).build(), Character.builder(62).build()).build()).build(), Terminal.builder(Sequence.builder(Character.builder(58).build(), Character.builder(58).build()).build()).build(), Terminal.builder(Sequence.builder(Character.builder(46).build(), Character.builder(46).build()).build()).build(), Terminal.builder(Sequence.builder(Character.builder(64).build()).build()).build()).build()))).build()).setLayoutStrategy(NO_LAYOUT).build())
		// Special ::= ()) 
		...
		// TopDecl ::= (d a t a) (Context (= >))? SimpleType (w h e r e) GADTDecls 
		...
		// TopDecl ::= (d e r i v i n g) (i n s t a n c e) (SContext (= >))? QTyCls Inst 
