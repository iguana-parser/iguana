...
public class DanglingElseGrammar3 {
	...
	private SPPFNode getExpectedSPPF(GrammarSlotRegistry registry) {
		...
		TerminalNode node13 = factory.createTerminalNode("s", 2, 1);
		node12.addChild(node13);
		node11.addChild(node12);
		node9.addChild(node10);
		node9.addChild(node11);
		node8.addChild(node9);
		TerminalNode node14 = factory.createTerminalNode("b", 3, 1);
		...
		TerminalNode node17 = factory.createTerminalNode("s", 4, 1);
