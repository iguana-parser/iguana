...
public class IndirectRecursion3Test {
	...
	private SPPFNode getSPPFNode1(GrammarSlotRegistry registry) {
		...
		TerminalNode node12 = factory.createTerminalNode("f", 1, 1);
		node8.addChild(node9);
		node8.addChild(node12);
		node7.addChild(node8);
		TerminalNode node13 = factory.createTerminalNode("c", 2, 1);
		node6.addChild(node7);
		node6.addChild(node13);
		node5.addChild(node6);
		TerminalNode node14 = factory.createTerminalNode("f", 3, 1);
		node4.addChild(node5);
		node4.addChild(node14);
		node3.addChild(node4);
		TerminalNode node15 = factory.createTerminalNode("c", 4, 1);
	...
	private SPPFNode getSPPFNode2(GrammarSlotRegistry registry) {
		...
		TerminalNode node16 = factory.createTerminalNode("g", 1, 1);
		node12.addChild(node13);
		node12.addChild(node16);
		node11.addChild(node12);
		TerminalNode node17 = factory.createTerminalNode("d", 2, 1);
		node10.addChild(node11);
		node10.addChild(node17);
		node9.addChild(node10);
		TerminalNode node18 = factory.createTerminalNode("g", 3, 1);
		node8.addChild(node9);
		node8.addChild(node18);
		node7.addChild(node8);
		TerminalNode node19 = factory.createTerminalNode("d", 4, 1);
		node6.addChild(node7);
		node6.addChild(node19);
		node5.addChild(node6);
		TerminalNode node20 = factory.createTerminalNode("g", 5, 1);
		node4.addChild(node5);
		node4.addChild(node20);
		node3.addChild(node4);
		TerminalNode node21 = factory.createTerminalNode("d", 6, 1);
		node2.addChild(node3);
	...
	private SPPFNode getSPPFNode3(GrammarSlotRegistry registry) {
		...
		node10.addChild(node17);
		node9.addChild(node10);
		TerminalNode node18 = factory.createTerminalNode("f", 3, 1);
		node8.addChild(node9);
		node8.addChild(node18);
		node7.addChild(node8);
		TerminalNode node19 = factory.createTerminalNode("c", 4, 1);
		node6.addChild(node7);
		node6.addChild(node19);
		node5.addChild(node6);
		TerminalNode node20 = factory.createTerminalNode("g", 5, 1);
