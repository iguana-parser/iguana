...
public class IndirectRecursion3Test {
	...
	private SPPFNode getSPPFNode1() {
		...
		NonterminalNode node3 = factory.createNonterminalNode("B", 0, 4).init();
		PackedNode node4 = factory.createPackedNode("B ::= A f .", 3, node3);
		NonterminalNode node5 = factory.createNonterminalNode("A", 0, 3).init();
		PackedNode node6 = factory.createPackedNode("A ::= B c .", 2, node5);
		NonterminalNode node7 = factory.createNonterminalNode("B", 0, 2).init();
		PackedNode node8 = factory.createPackedNode("B ::= A f .", 1, node7);
		NonterminalNode node9 = factory.createNonterminalNode("A", 0, 1).init();
		PackedNode node10 = factory.createPackedNode("A ::= e .", 0, node9);
		TerminalSymbolNode node11 = factory.createTokenNode("e", 0, 1);
		node10.addChild(node11);
		node9.addChild(node10);
		TerminalSymbolNode node12 = factory.createTokenNode("f", 1, 1);
		node8.addChild(node9);
		node8.addChild(node12);
		node7.addChild(node8);
		TerminalSymbolNode node13 = factory.createTokenNode("c", 2, 1);
		node6.addChild(node7);
		node6.addChild(node13);
		node5.addChild(node6);
		TerminalSymbolNode node14 = factory.createTokenNode("f", 3, 1);
		node4.addChild(node5);
		node4.addChild(node14);
		node3.addChild(node4);
		TerminalSymbolNode node15 = factory.createTokenNode("c", 4, 1);
	...
	private SPPFNode getSPPFNode2() {
		SPPFNodeFactory factory = new SPPFNodeFactory(grammar.toGrammarGraph());
		NonterminalNode node1 = factory.createNonterminalNode("A", 0, 7).init();
		PackedNode node2 = factory.createPackedNode("A ::= C d .", 6, node1);
		NonterminalNode node3 = factory.createNonterminalNode("C", 0, 6).init();
		PackedNode node4 = factory.createPackedNode("C ::= A g .", 5, node3);
		NonterminalNode node5 = factory.createNonterminalNode("A", 0, 5).init();
		PackedNode node6 = factory.createPackedNode("A ::= C d .", 4, node5);
		NonterminalNode node7 = factory.createNonterminalNode("C", 0, 4).init();
		PackedNode node8 = factory.createPackedNode("C ::= A g .", 3, node7);
		NonterminalNode node9 = factory.createNonterminalNode("A", 0, 3).init();
		PackedNode node10 = factory.createPackedNode("A ::= C d .", 2, node9);
		NonterminalNode node11 = factory.createNonterminalNode("C", 0, 2).init();
		PackedNode node12 = factory.createPackedNode("C ::= A g .", 1, node11);
		NonterminalNode node13 = factory.createNonterminalNode("A", 0, 1).init();
		PackedNode node14 = factory.createPackedNode("A ::= e .", 0, node13);
		TerminalSymbolNode node15 = factory.createTokenNode("e", 0, 1);
		node14.addChild(node15);
		node13.addChild(node14);
		TerminalSymbolNode node16 = factory.createTokenNode("g", 1, 1);
		node12.addChild(node13);
		node12.addChild(node16);
		node11.addChild(node12);
		TerminalSymbolNode node17 = factory.createTokenNode("d", 2, 1);
		node10.addChild(node11);
		node10.addChild(node17);
		node9.addChild(node10);
		TerminalSymbolNode node18 = factory.createTokenNode("g", 3, 1);
		node8.addChild(node9);
		node8.addChild(node18);
		node7.addChild(node8);
		TerminalSymbolNode node19 = factory.createTokenNode("d", 4, 1);
		node6.addChild(node7);
		node6.addChild(node19);
		node5.addChild(node6);
		TerminalSymbolNode node20 = factory.createTokenNode("g", 5, 1);
		node4.addChild(node5);
		node4.addChild(node20);
		node3.addChild(node4);
		TerminalSymbolNode node21 = factory.createTokenNode("d", 6, 1);
		node2.addChild(node3);
	...
	private SPPFNode getSPPFNode3() {
		...
		NonterminalNode node7 = factory.createNonterminalNode("B", 0, 4).init();
		...
		node10.addChild(node17);
		node9.addChild(node10);
		TerminalSymbolNode node18 = factory.createTokenNode("f", 3, 1);
		node8.addChild(node9);
		node8.addChild(node18);
		node7.addChild(node8);
		TerminalSymbolNode node19 = factory.createTokenNode("c", 4, 1);
		node6.addChild(node7);
		node6.addChild(node19);
		node5.addChild(node6);
		TerminalSymbolNode node20 = factory.createTokenNode("g", 5, 1);
