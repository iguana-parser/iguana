...
public class Test13 {
	...
	public void testParser() {
		...
		assertEquals(true, result.asParseSuccess().getRoot().deepEquals(expectedSPPF()));
	}
	...
	private SPPFNode expectedSPPF() {
		...
		TokenSymbolNode node12 = factory.createTokenNode("epsilon", 1, 0);
		...
		TokenSymbolNode node16 = factory.createTokenNode("epsilon", 0, 0);
