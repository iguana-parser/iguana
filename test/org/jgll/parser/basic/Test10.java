...
public class Test10 extends AbstractParserTest {
    ...
    public Test10(Configuration config, Input input, Grammar grammar,
    ...
    public static Collection<Object[]> data() {
        return Arrays.asList(new Object[][] {
        		{ DEFAULT,  Input.fromString("abc"), getGrammar(), (Function<GrammarRegistry, SPPFNode>) Test10::expectedSPPF },
        		{ CONFIG_1, Input.fromString("abc"), getGrammar(), (Function<GrammarRegistry, SPPFNode>) Test10::expectedSPPF },
        		{ CONFIG_2, Input.fromString("abc"), getGrammar(), (Function<GrammarRegistry, SPPFNode>) Test10::expectedSPPF },
        		{ CONFIG_3, Input.fromString("abc"), getGrammar(), (Function<GrammarRegistry, SPPFNode>) Test10::expectedSPPF }
           });
    }
	...
	private static SPPFNode expectedSPPF(GrammarRegistry registry) {
		...
		IntermediateNode node3 = factory.createIntermediateNode("S ::= A B . C", 0, 2);
		...
		NonterminalNode node11 = factory.createNonterminalNode("C", 0, 2, 3);
		...
		IntermediateNode node15 = factory.createIntermediateNode("S ::= A B . D", 0, 2);
		PackedNode node16 = factory.createPackedNode("S ::= A B . D", 1, node15);
		node16.addChild(node5);
		node16.addChild(node8);
		node15.addChild(node16);
		NonterminalNode node19 = factory.createNonterminalNode("D", 0, 2, 3);
