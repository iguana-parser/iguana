...
//		assertTrue(grammarGraph.isLL1SubGrammar(C));
	...
	private SPPFNode getSPPF1() {
		...
		TerminalSymbolNode node8 = factory.createTokenNode("b", 1, 1);
		node7.addChild(node8);
		node6.addChild(node7);
		node4.addChild(node5);
		node4.addChild(node6);
		node3.addChild(node4);
		TerminalSymbolNode node9 = factory.createTokenNode("c", 2, 1);
	...
	private SPPFNode getSPPF2() {
		...
		TerminalSymbolNode node8 = factory.createTokenNode("a", 1, 1);
