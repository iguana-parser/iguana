...
//		assertTrue(grammarGraph.isLL1SubGrammar(C));
	...
	private SPPFNode getSPPF1(GrammarSlotRegistry registry) {
		...
		TerminalNode node8 = factory.createTokenNode("b", 1, 2);
