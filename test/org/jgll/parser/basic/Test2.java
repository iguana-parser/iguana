...
public class Test2 extends AbstractParserTest {
    ...
    public Test2(Configuration config, Input input, Grammar grammar,
    ...
    public static Collection<Object[]> data() {
        return Arrays.asList(new Object[][] {
        		{ DEFAULT,  Input.fromString("a"), getGrammar(), (Function<GrammarRegistry, SPPFNode>) Test2::expectedSPPF },
        		{ CONFIG_1, Input.fromString("a"), getGrammar(), (Function<GrammarRegistry, SPPFNode>) Test2::expectedSPPF },
        		{ CONFIG_2, Input.fromString("a"), getGrammar(), (Function<GrammarRegistry, SPPFNode>) Test2::expectedSPPF },
        		{ CONFIG_3, Input.fromString("a"), getGrammar(), (Function<GrammarRegistry, SPPFNode>) Test2::expectedSPPF }
           });
    }
