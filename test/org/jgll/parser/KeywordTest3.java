...
public class KeywordTest3 {
	...
	private SPPFNode getSPPF(GrammarSlotRegistry registry) {
		...
		TerminalNode node16 = factory.createTerminalNode("\\u0020", 2, 1);
		...
		TerminalNode node19 = factory.createTerminalNode("s", 3, 1);
		...
		TerminalNode node22 = factory.createTerminalNode("\\u0020", 4, 1);
		node21.addChild(node22);
		node20.addChild(node21);
		node8.addChild(node9);
		node8.addChild(node20);
		node7.addChild(node8);
		TerminalNode node23 = factory.createTerminalNode("t h e n", 5, 4);
		...
		TerminalNode node26 = factory.createTerminalNode("\\u0020", 9, 1);
		...
		TerminalNode node29 = factory.createTerminalNode("s", 10, 1);
