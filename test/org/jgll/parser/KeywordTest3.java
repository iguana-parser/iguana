...
public class KeywordTest3 {
	...
	private SPPFNode getSPPF() {
		...
		TerminalSymbolNode node19 = factory.createTokenNode("s", 3, 1);
		...
		TerminalSymbolNode node22 = factory.createTokenNode("\\u0020", 4, 1);
		node21.addChild(node22);
		node20.addChild(node21);
		node8.addChild(node9);
		node8.addChild(node20);
		node7.addChild(node8);
		TerminalSymbolNode node23 = factory.createTokenNode("t h e n", 5, 4);
		...
		TerminalSymbolNode node26 = factory.createTokenNode("\\u0020", 9, 1);
		...
		TerminalSymbolNode node29 = factory.createTokenNode("s", 10, 1);
