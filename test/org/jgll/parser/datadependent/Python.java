...
public class Python {
	...
	public static Grammar grammar = 
			 ...
			 * 
			 * @layout(NoNL)
			 * IfStmt ::= l:"if" Test ":" Suite(indent(l@lExt)) ("elif" Test ":" Suite)* ("else" ":" Suite)?
			 */ 
