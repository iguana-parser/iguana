...
public class DanglingElseGrammar1 {
	...
	private SPPFNode getExpectedSPPF1() {
		...
		TerminalNode node15 = factory.createTokenNode("s", 2, 1);
		node14.addChild(node15);
		node13.addChild(node14);
		node11.addChild(node12);
		node11.addChild(node13);
		node10.addChild(node11);
		TerminalNode node16 = factory.createTokenNode("b", 3, 1);
		...
		TerminalNode node19 = factory.createTokenNode("s", 4, 1);
	...
	private SPPFNode getExpectedSPPF2() {
		...
		TerminalNode node15 = factory.createTokenNode("a", 2, 1);
		...
		TerminalNode node24 = factory.createTokenNode("a", 3, 1);
		...
		TerminalNode node40 = factory.createTokenNode("s", 7, 1);
		...
		node22.addChild(node23);
		TerminalNode node41 = factory.createTokenNode("b", 8, 1);
		node21.addChild(node22);
		...
		TerminalNode node44 = factory.createTokenNode("s", 9, 1);
		...
		node13.addChild(node14);
		TerminalNode node45 = factory.createTokenNode("b", 10, 1);
		...
		TerminalNode node48 = factory.createTokenNode("s", 11, 1);
