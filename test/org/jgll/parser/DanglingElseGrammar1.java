...
public class DanglingElseGrammar1 {
	...
	public void test1() {
		...
		assertTrue(result.asParseSuccess().getRoot().deepEquals(getExpectedSPPF1()));
	}
	...
	public void test2() {
		...
		assertTrue(result.isParseSuccess());
		assertTrue(result.asParseSuccess().getRoot().deepEquals(getExpectedSPPF2()));
	}
	...
	private SPPFNode getExpectedSPPF1() {
		...
		TerminalSymbolNode node12 = factory.createTokenNode("a", 1, 1);
		NonterminalNode node13 = factory.createNonterminalNode("S", 0, 2, 3).init();
		PackedNode node14 = factory.createPackedNode("S ::= s .", 2, node13);
		TerminalSymbolNode node15 = factory.createTokenNode("s", 2, 1);
		node14.addChild(node15);
		node13.addChild(node14);
		node11.addChild(node12);
		node11.addChild(node13);
		node10.addChild(node11);
		TerminalSymbolNode node16 = factory.createTokenNode("b", 3, 1);
		...
		TerminalSymbolNode node19 = factory.createTokenNode("s", 4, 1);
	...
	private SPPFNode getExpectedSPPF2() {
		...
		TerminalSymbolNode node6 = factory.createTokenNode("a", 1, 1);
		...
		TerminalSymbolNode node15 = factory.createTokenNode("a", 2, 1);
		...
		TerminalSymbolNode node24 = factory.createTokenNode("a", 3, 1);
		...
		TerminalSymbolNode node40 = factory.createTokenNode("s", 7, 1);
		...
		node22.addChild(node23);
		TerminalSymbolNode node41 = factory.createTokenNode("b", 8, 1);
		node21.addChild(node22);
		...
		TerminalSymbolNode node44 = factory.createTokenNode("s", 9, 1);
		...
		node13.addChild(node14);
		TerminalSymbolNode node45 = factory.createTokenNode("b", 10, 1);
		...
		TerminalSymbolNode node48 = factory.createTokenNode("s", 11, 1);
