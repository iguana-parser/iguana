...
//		assertEquals(25154, parseStatistics.getDescriptorsCount());
	...
	private SPPFNode getSPPF1() {
		...
		TerminalSymbolNode node10 = factory.createTokenNode("b", 1, 1);
		...
		TerminalSymbolNode node13 = factory.createTokenNode("b", 2, 1);
	...
	private SPPFNode getSPPF2() {
		...
		TerminalSymbolNode node12 = factory.createTokenNode("b", 1, 1);
		node11.addChild(node12);
		...
		TerminalSymbolNode node15 = factory.createTokenNode("b", 2, 1);
		node14.addChild(node15);
		...
		TerminalSymbolNode node18 = factory.createTokenNode("b", 3, 1);
		node17.addChild(node18);
	...
	private SPPFNode getSPPF3() {
		...
		TerminalSymbolNode node20 = factory.createTokenNode("b", 3, 1);
		node19.addChild(node20);
		node18.addChild(node19);
		node9.addChild(node10);
		...
		TerminalSymbolNode node29 = factory.createTokenNode("b", 4, 1);
		node28.addChild(node29);
