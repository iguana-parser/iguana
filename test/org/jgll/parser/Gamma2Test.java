...
public class Gamma2Test {
	...
	private SPPFNode getSPPF1() {
		...
		PackedNode node4 = new PackedNode(grammarGraph.getPackedNodeId(S, b), 0, node3);
		...
		PackedNode node7 = new PackedNode(grammarGraph.getPackedNodeId(S, S, S), 2, node6);
		NonterminalNode node8 = factory.createNonterminalNode(S, 1, 2).init();
		PackedNode node9 = new PackedNode(grammarGraph.getPackedNodeId(S, b), 1, node8);
		...
		PackedNode node12 = new PackedNode(grammarGraph.getPackedNodeId(S, b), 2, node11);
		...
		PackedNode node14 = new PackedNode(grammarGraph.getPackedNodeId(S, S, S), 2, node1);
		NonterminalNode node15 = factory.createNonterminalNode(S, 0, 2).init();
		PackedNode node16 = new PackedNode(grammarGraph.getPackedNodeId(S, S, S), 1, node15);
		node16.addChild(node3);
		node16.addChild(node8);
		node15.addChild(node16);
		node14.addChild(node15);
		node14.addChild(node11);
		PackedNode node17 = new PackedNode(grammarGraph.getPackedNodeId(S, S, S, S), 2, node1);
		IntermediateNode node18 = factory.createIntermediateNode("S ::= S S . S", 0, 2).init();
		PackedNode node19 = new PackedNode(grammarGraph.getIntermediateNodeId("S ::= S S . S"), 1, node18);
	...
	private SPPFNode getSPPF2() {
		...
		PackedNode node7 = new PackedNode(grammarGraph.getPackedNodeId(S, S, S, S), 3, node6);
		IntermediateNode node8 = factory.createIntermediateNode("S ::= S S . S", 1, 3).init();
		PackedNode node9 = new PackedNode(grammarGraph.getIntermediateNodeId("S ::= S S . S"), 2, node8);
		NonterminalNode node10 = factory.createNonterminalNode(S, 1, 2).init();
		PackedNode node11 = new PackedNode(grammarGraph.getPackedNodeId(S, b), 1, node10);
		TokenSymbolNode node12 = factory.createTokenNode(b, 1, 1);
		node11.addChild(node12);
		node10.addChild(node11);
		NonterminalNode node13 = factory.createNonterminalNode(S, 2, 3).init();
		PackedNode node14 = new PackedNode(grammarGraph.getPackedNodeId(S, b), 2, node13);
		...
		PackedNode node17 = new PackedNode(grammarGraph.getPackedNodeId(S, b), 3, node16);
		TokenSymbolNode node18 = factory.createTokenNode(b, 3, 1);
		node17.addChild(node18);
		node16.addChild(node17);
		node7.addChild(node8);
		node7.addChild(node16);
		PackedNode node19 = new PackedNode(grammarGraph.getPackedNodeId(S, S, S), 2, node6);
		NonterminalNode node20 = factory.createNonterminalNode(S, 2, 4).init();
		PackedNode node21 = new PackedNode(grammarGraph.getPackedNodeId(S, S, S), 3, node20);
		node21.addChild(node13);
		node21.addChild(node16);
		node20.addChild(node21);
		node19.addChild(node10);
		node19.addChild(node20);
		PackedNode node22 = new PackedNode(grammarGraph.getPackedNodeId(S, S, S), 3, node6);
		NonterminalNode node23 = factory.createNonterminalNode(S, 1, 3).init();
		PackedNode node24 = new PackedNode(grammarGraph.getPackedNodeId(S, S, S), 2, node23);
		...
		node2.addChild(node3);
		node2.addChild(node6);
		PackedNode node25 = new PackedNode(grammarGraph.getPackedNodeId(S, S, S), 3, node1);
		NonterminalNode node26 = factory.createNonterminalNode(S, 0, 3).init();
		PackedNode node27 = new PackedNode(grammarGraph.getPackedNodeId(S, S, S), 1, node26);
		node27.addChild(node3);
		node27.addChild(node23);
		PackedNode node28 = new PackedNode(grammarGraph.getPackedNodeId(S, S, S), 2, node26);
		NonterminalNode node29 = factory.createNonterminalNode(S, 0, 2).init();
		PackedNode node30 = new PackedNode(grammarGraph.getPackedNodeId(S, S, S), 1, node29);
		node30.addChild(node3);
		node30.addChild(node10);
		node29.addChild(node30);
		node28.addChild(node29);
		node28.addChild(node13);
		PackedNode node31 = new PackedNode(grammarGraph.getPackedNodeId(S, S, S, S), 2, node26);
		IntermediateNode node32 = factory.createIntermediateNode("S ::= S S . S", 0, 2).init();
		PackedNode node33 = new PackedNode(grammarGraph.getIntermediateNodeId("S ::= S S . S"), 1, node32);
		...
		PackedNode node34 = new PackedNode(grammarGraph.getPackedNodeId(S, S, S), 2, node1);
		node34.addChild(node29);
		node34.addChild(node20);
		PackedNode node35 = new PackedNode(grammarGraph.getPackedNodeId(S, S, S, S), 3, node1);
		IntermediateNode node36 = factory.createIntermediateNode("S ::= S S . S", 0, 3).init();
		PackedNode node37 = new PackedNode(grammarGraph.getIntermediateNodeId("S ::= S S . S"), 2, node36);
		node37.addChild(node29);
		node37.addChild(node13);
		PackedNode node38 = new PackedNode(grammarGraph.getIntermediateNodeId("S ::= S S . S"), 1, node36);
		...
		PackedNode node39 = new PackedNode(grammarGraph.getPackedNodeId(S, S, S, S), 2, node1);
	...
	private SPPFNode getSPPF3() {
		...
		PackedNode node7 = new PackedNode(grammarGraph.getPackedNodeId(S, S, S), 4, node6);
		NonterminalNode node8 = factory.createNonterminalNode(S, 1, 4).init();
		PackedNode node9 = new PackedNode(grammarGraph.getPackedNodeId(S, S, S, S), 3, node8);
		IntermediateNode node10 = factory.createIntermediateNode("S ::= S S . S", 1, 3).init();
		PackedNode node11 = new PackedNode(grammarGraph.getIntermediateNodeId("S ::= S S . S"), 2, node10);
		NonterminalNode node12 = factory.createNonterminalNode(S, 1, 2).init();
		PackedNode node13 = new PackedNode(grammarGraph.getPackedNodeId(S, b), 1, node12);
		TokenSymbolNode node14 = factory.createTokenNode(b, 1, 1);
		node13.addChild(node14);
		node12.addChild(node13);
		NonterminalNode node15 = factory.createNonterminalNode(S, 2, 3).init();
		PackedNode node16 = new PackedNode(grammarGraph.getPackedNodeId(S, b), 2, node15);
		...
		PackedNode node19 = new PackedNode(grammarGraph.getPackedNodeId(S, b), 3, node18);
		TokenSymbolNode node20 = factory.createTokenNode(b, 3, 1);
		node19.addChild(node20);
		node18.addChild(node19);
		node9.addChild(node10);
		node9.addChild(node18);
		PackedNode node21 = new PackedNode(grammarGraph.getPackedNodeId(S, S, S), 2, node8);
		NonterminalNode node22 = factory.createNonterminalNode(S, 2, 4).init();
		PackedNode node23 = new PackedNode(grammarGraph.getPackedNodeId(S, S, S), 3, node22);
		node23.addChild(node15);
		node23.addChild(node18);
		node22.addChild(node23);
		node21.addChild(node12);
		node21.addChild(node22);
		PackedNode node24 = new PackedNode(grammarGraph.getPackedNodeId(S, S, S), 3, node8);
		NonterminalNode node25 = factory.createNonterminalNode(S, 1, 3).init();
		PackedNode node26 = new PackedNode(grammarGraph.getPackedNodeId(S, S, S), 2, node25);
		...
		PackedNode node28 = new PackedNode(grammarGraph.getPackedNodeId(S, b), 4, node27);
		TokenSymbolNode node29 = factory.createTokenNode(b, 4, 1);
		node28.addChild(node29);
		node27.addChild(node28);
		node7.addChild(node8);
		node7.addChild(node27);
		PackedNode node30 = new PackedNode(grammarGraph.getPackedNodeId(S, S, S, S), 3, node6);
		NonterminalNode node31 = factory.createNonterminalNode(S, 3, 5).init();
		PackedNode node32 = new PackedNode(grammarGraph.getPackedNodeId(S, S, S), 4, node31);
		node32.addChild(node18);
		node32.addChild(node27);
		node31.addChild(node32);
		node30.addChild(node10);
		node30.addChild(node31);
		PackedNode node33 = new PackedNode(grammarGraph.getPackedNodeId(S, S, S, S), 4, node6);
		IntermediateNode node34 = factory.createIntermediateNode("S ::= S S . S", 1, 4).init();
		PackedNode node35 = new PackedNode(grammarGraph.getIntermediateNodeId("S ::= S S . S"), 2, node34);
		node35.addChild(node12);
		node35.addChild(node22);
		PackedNode node36 = new PackedNode(grammarGraph.getIntermediateNodeId("S ::= S S . S"), 3, node34);
		...
		PackedNode node37 = new PackedNode(grammarGraph.getPackedNodeId(S, S, S), 2, node6);
		NonterminalNode node38 = factory.createNonterminalNode(S, 2, 5).init();
		PackedNode node39 = new PackedNode(grammarGraph.getPackedNodeId(S, S, S, S), 4, node38);
		IntermediateNode node40 = factory.createIntermediateNode("S ::= S S . S", 2, 4).init();
		PackedNode node41 = new PackedNode(grammarGraph.getIntermediateNodeId("S ::= S S . S"), 3, node40);
		node41.addChild(node15);
		node41.addChild(node18);
		node40.addChild(node41);
		node39.addChild(node40);
		node39.addChild(node27);
		PackedNode node42 = new PackedNode(grammarGraph.getPackedNodeId(S, S, S), 3, node38);
		node42.addChild(node15);
		node42.addChild(node31);
		PackedNode node43 = new PackedNode(grammarGraph.getPackedNodeId(S, S, S), 4, node38);
		...
		PackedNode node44 = new PackedNode(grammarGraph.getPackedNodeId(S, S, S), 3, node6);
		...
		node2.addChild(node3);
		node2.addChild(node6);
		PackedNode node45 = new PackedNode(grammarGraph.getPackedNodeId(S, S, S), 4, node1);
		NonterminalNode node46 = factory.createNonterminalNode(S, 0, 4).init();
		PackedNode node47 = new PackedNode(grammarGraph.getPackedNodeId(S, S, S), 1, node46);
		node47.addChild(node3);
		node47.addChild(node8);
		PackedNode node48 = new PackedNode(grammarGraph.getPackedNodeId(S, S, S), 3, node46);
		NonterminalNode node49 = factory.createNonterminalNode(S, 0, 3).init();
		PackedNode node50 = new PackedNode(grammarGraph.getPackedNodeId(S, S, S), 1, node49);
		node50.addChild(node3);
		node50.addChild(node25);
		PackedNode node51 = new PackedNode(grammarGraph.getPackedNodeId(S, S, S), 2, node49);
		NonterminalNode node52 = factory.createNonterminalNode(S, 0, 2).init();
		PackedNode node53 = new PackedNode(grammarGraph.getPackedNodeId(S, S, S), 1, node52);
		node53.addChild(node3);
		node53.addChild(node12);
		node52.addChild(node53);
		node51.addChild(node52);
		node51.addChild(node15);
		PackedNode node54 = new PackedNode(grammarGraph.getPackedNodeId(S, S, S, S), 2, node49);
		IntermediateNode node55 = factory.createIntermediateNode("S ::= S S . S", 0, 2).init();
		PackedNode node56 = new PackedNode(grammarGraph.getIntermediateNodeId("S ::= S S . S"), 1, node55);
		...
		PackedNode node57 = new PackedNode(grammarGraph.getPackedNodeId(S, S, S), 2, node46);
		node57.addChild(node52);
		node57.addChild(node22);
		PackedNode node58 = new PackedNode(grammarGraph.getPackedNodeId(S, S, S, S), 3, node46);
		IntermediateNode node59 = factory.createIntermediateNode("S ::= S S . S", 0, 3).init();
		PackedNode node60 = new PackedNode(grammarGraph.getIntermediateNodeId("S ::= S S . S"), 2, node59);
		node60.addChild(node52);
		node60.addChild(node15);
		PackedNode node61 = new PackedNode(grammarGraph.getIntermediateNodeId("S ::= S S . S"), 1, node59);
		...
		PackedNode node62 = new PackedNode(grammarGraph.getPackedNodeId(S, S, S, S), 2, node46);
		...
		PackedNode node63 = new PackedNode(grammarGraph.getPackedNodeId(S, S, S), 3, node1);
		node63.addChild(node49);
		node63.addChild(node31);
		PackedNode node64 = new PackedNode(grammarGraph.getPackedNodeId(S, S, S, S), 4, node1);
		IntermediateNode node65 = factory.createIntermediateNode("S ::= S S . S", 0, 4).init();
		PackedNode node66 = new PackedNode(grammarGraph.getIntermediateNodeId("S ::= S S . S"), 3, node65);
		node66.addChild(node49);
		node66.addChild(node18);
		PackedNode node67 = new PackedNode(grammarGraph.getIntermediateNodeId("S ::= S S . S"), 2, node65);
		node67.addChild(node52);
		node67.addChild(node22);
		PackedNode node68 = new PackedNode(grammarGraph.getIntermediateNodeId("S ::= S S . S"), 1, node65);
		...
		PackedNode node69 = new PackedNode(grammarGraph.getPackedNodeId(S, S, S), 2, node1);
		node69.addChild(node52);
		node69.addChild(node38);
		PackedNode node70 = new PackedNode(grammarGraph.getPackedNodeId(S, S, S, S), 3, node1);
		node70.addChild(node59);
		node70.addChild(node31);
		PackedNode node71 = new PackedNode(grammarGraph.getPackedNodeId(S, S, S, S), 2, node1);
