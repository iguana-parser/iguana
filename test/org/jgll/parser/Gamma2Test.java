...
//		assertEquals(25154, parseStatistics.getDescriptorsCount());
	...
	private SPPFNode getSPPF1(GrammarSlotRegistry registry) {
		...
		TerminalNode node10 = factory.createTerminalNode("b", 1, 1);
		...
		TerminalNode node13 = factory.createTerminalNode("b", 2, 1);
	...
	private SPPFNode getSPPF2(GrammarSlotRegistry registry) {
		...
		TerminalNode node12 = factory.createTerminalNode("b", 1, 1);
		node11.addChild(node12);
		...
		TerminalNode node15 = factory.createTerminalNode("b", 2, 1);
		node14.addChild(node15);
		...
		TerminalNode node18 = factory.createTerminalNode("b", 3, 1);
		node17.addChild(node18);
	...
	private SPPFNode getSPPF3(GrammarSlotRegistry registry) {
		...
		TerminalNode node20 = factory.createTerminalNode("b", 3, 1);
		node19.addChild(node20);
		node18.addChild(node19);
		node9.addChild(node10);
		...
		TerminalNode node29 = factory.createTerminalNode("b", 4, 1);
		node28.addChild(node29);
