...
//		assertEquals(25154, parseStatistics.getDescriptorsCount());
	...
	private SPPFNode getSPPF1() {
		...
		TerminalNode node13 = factory.createTokenNode("b", 2, 1);
	...
	private SPPFNode getSPPF2() {
		...
		TerminalNode node12 = factory.createTokenNode("b", 1, 1);
		node11.addChild(node12);
		...
		TerminalNode node15 = factory.createTokenNode("b", 2, 1);
		node14.addChild(node15);
		...
		TerminalNode node18 = factory.createTokenNode("b", 3, 1);
		node17.addChild(node18);
	...
	private SPPFNode getSPPF3() {
		...
		TerminalNode node20 = factory.createTokenNode("b", 3, 1);
		node19.addChild(node20);
		node18.addChild(node19);
		node9.addChild(node10);
		...
		TerminalNode node29 = factory.createTokenNode("b", 4, 1);
		node28.addChild(node29);
