...
public class LeftFactorizedArithmeticGrammarTest {
	...
	private SPPFNode getSPPF() {
		...
		NonterminalSymbolNode node3 = factory.createNonterminalNode(F, 0, 1);
		TokenSymbolNode node4 = factory.createTokenNode(a, 0, 1);
		node3.addChild(node4);
		NonterminalSymbolNode node5 = factory.createNonterminalNode(T1, 1, 1);
		node2.addChild(node3);
		node2.addChild(node5);
		NonterminalSymbolNode node6 = factory.createNonterminalNode(E1, 1, 7);
		...
		NonterminalSymbolNode node9 = factory.createNonterminalNode(T, 2, 5);
		NonterminalSymbolNode node10 = factory.createNonterminalNode(F, 2, 3);
		TokenSymbolNode node11 = factory.createTokenNode(a, 2, 1);
		node10.addChild(node11);
		NonterminalSymbolNode node12 = factory.createNonterminalNode(T1, 3, 5);
		...
		NonterminalSymbolNode node15 = factory.createNonterminalNode(F, 4, 5);
		TokenSymbolNode node16 = factory.createTokenNode(a, 4, 1);
		node15.addChild(node16);
		node13.addChild(node14);
		node13.addChild(node15);
		NonterminalSymbolNode node17 = factory.createNonterminalNode(T1, 5, 5);
		...
		NonterminalSymbolNode node18 = factory.createNonterminalNode(E1, 5, 7);
		...
		NonterminalSymbolNode node21 = factory.createNonterminalNode(T, 6, 7);
		NonterminalSymbolNode node22 = factory.createNonterminalNode(F, 6, 7);
		TokenSymbolNode node23 = factory.createTokenNode(a, 6, 1);
		node22.addChild(node23);
		NonterminalSymbolNode node24 = factory.createNonterminalNode(T1, 7, 7);
		node21.addChild(node22);
		node21.addChild(node24);
		node19.addChild(node20);
		node19.addChild(node21);
		NonterminalSymbolNode node25 = factory.createNonterminalNode(E1, 7, 7);
