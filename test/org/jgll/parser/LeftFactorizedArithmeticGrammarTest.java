...
public class LeftFactorizedArithmeticGrammarTest {
	...
	private SPPFNode getSPPF(GrammarSlotRegistry registry) {
		...
		TerminalNode node14 = factory.createTerminalNode("+", 1, 1);
		...
		TerminalNode node19 = factory.createTerminalNode("a", 2, 1);
		...
		TerminalNode node27 = factory.createTerminalNode("a", 4, 1);
		...
		TerminalNode node34 = factory.createTerminalNode("+", 5, 1);
		...
		TerminalNode node39 = factory.createTerminalNode("a", 6, 1);
