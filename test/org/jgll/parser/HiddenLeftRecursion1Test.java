...
public class HiddenLeftRecursion1Test {
	...
	private SPPFNode getSPPFNode3(GrammarSlotRegistry registry) {
		...
		PackedNode node41 = factory.createPackedNode("A ::= c .", 0, node40);
	...
	private SPPFNode getSPPFNode4(GrammarSlotRegistry registry) {
		...
		PackedNode node33 = factory.createPackedNode("B ::= x .", 0, node32);
		...
		PackedNode node36 = factory.createPackedNode("A ::= c .", 1, node35);
	...
	private SPPFNode getSPPFNode5(GrammarSlotRegistry registry) {
		...
		PackedNode node28 = factory.createPackedNode("D ::= y .", 0, node27);
		...
		PackedNode node53 = factory.createPackedNode("A ::= c .", 1, node52);
