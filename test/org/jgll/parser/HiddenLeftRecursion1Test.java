...
public class HiddenLeftRecursion1Test {
	...
	private SPPFNode getSPPFNode1() {
		...
		TokenSymbolNode node7 = factory.createTokenNode("x", 0, 1);
		...
		TokenSymbolNode node10 = factory.createTokenNode("c", 1, 1);
	...
	private SPPFNode getSPPFNode2() {
		...
		TokenSymbolNode node7 = factory.createTokenNode("y", 0, 1);
		node6.addChild(node7);
		node5.addChild(node6);
		NonterminalNode node8 = factory.createNonterminalNode("A", 1, 2).init();
		PackedNode node9 = factory.createPackedNode("A ::= c .", 1, node8);
	...
	private SPPFNode getSPPFNode3() {
		...
		TokenSymbolNode node37 = factory.createTokenNode("b", 2, 1);
		...
		TokenSymbolNode node38 = factory.createTokenNode("a", 3, 1);
		...
		TokenSymbolNode node39 = factory.createTokenNode("b", 4, 1);
		...
		node3.addChild(node4);
		TokenSymbolNode node42 = factory.createTokenNode("b", 7, 1);
		node2.addChild(node3);
	...
	private SPPFNode getSPPFNode4() {
		...
		TokenSymbolNode node29 = factory.createTokenNode("x", 0, 1);
		node28.addChild(node29);
		node27.addChild(node28);
		NonterminalNode node30 = factory.createNonterminalNode("A", 1, 2).init();
		PackedNode node31 = factory.createPackedNode("A ::= c .", 1, node30);
		TokenSymbolNode node32 = factory.createTokenNode("c", 1, 1);
		node31.addChild(node32);
		node30.addChild(node31);
		node26.addChild(node27);
		node26.addChild(node30);
		node25.addChild(node26);
		TokenSymbolNode node33 = factory.createTokenNode("a", 2, 1);
		node24.addChild(node25);
		...
		node22.addChild(node23);
		node21.addChild(node22);
		TokenSymbolNode node34 = factory.createTokenNode("b", 3, 1);
		node20.addChild(node21);
		...
		node18.addChild(node19);
		node17.addChild(node18);
		TokenSymbolNode node35 = factory.createTokenNode("b", 4, 1);
		node16.addChild(node17);
		...
		node14.addChild(node15);
		node13.addChild(node14);
		TokenSymbolNode node36 = factory.createTokenNode("b", 5, 1);
		...
		node10.addChild(node11);
		node9.addChild(node10);
		TokenSymbolNode node37 = factory.createTokenNode("b", 6, 1);
		node8.addChild(node9);
		...
		node4.addChild(node7);
		node3.addChild(node4);
		TokenSymbolNode node38 = factory.createTokenNode("b", 7, 1);
		node2.addChild(node3);
	...
	private SPPFNode getSPPFNode5() {
		...
		TokenSymbolNode node25 = factory.createTokenNode("y", 0, 1);
		node24.addChild(node25);
		node23.addChild(node24);
		...
		TokenSymbolNode node48 = factory.createTokenNode("a", 3, 1);
		...
		node34.addChild(node35);
		TokenSymbolNode node49 = factory.createTokenNode("a", 4, 1);
		node33.addChild(node34);
		...
		node28.addChild(node29);
		TokenSymbolNode node50 = factory.createTokenNode("a", 5, 1);
		node27.addChild(node28);
		...
		node21.addChild(node22);
		TokenSymbolNode node51 = factory.createTokenNode("b", 6, 1);
		node20.addChild(node21);
		...
		node18.addChild(node19);
		node17.addChild(node18);
		TokenSymbolNode node52 = factory.createTokenNode("a", 7, 1);
		node16.addChild(node17);
		...
		node14.addChild(node15);
		node13.addChild(node14);
		TokenSymbolNode node53 = factory.createTokenNode("a", 8, 1);
		node12.addChild(node13);
		...
		node10.addChild(node11);
		node9.addChild(node10);
		TokenSymbolNode node54 = factory.createTokenNode("a", 9, 1);
		node8.addChild(node9);
		...
		node4.addChild(node7);
		node3.addChild(node4);
		TokenSymbolNode node55 = factory.createTokenNode("a", 10, 1);
		node2.addChild(node3);
