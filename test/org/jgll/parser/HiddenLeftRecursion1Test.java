...
public class HiddenLeftRecursion1Test {
	...
	private SPPFNode getSPPFNode1() {
		...
		NonterminalNode node5 = factory.createNonterminalNode(A, 1, 2);
	...
	private SPPFNode getSPPFNode2() {
		...
		NonterminalNode node3 = factory.createNonterminalNode(D, 0, 1);
	...
	private SPPFNode getSPPFNode3() {
		GrammarGraph grammarGraph = grammar.toGrammarGraph();
		SPPFNodeFactory factory = new SPPFNodeFactory(grammarGraph);
		NonterminalNode node1 = factory.createNonterminalNode(A, 0, 8);
		IntermediateNode node2 = factory.createIntermediateNode(list(D, A), 0, 7);
		NonterminalNode node3 = factory.createNonterminalNode(D, 0, 0);
		NonterminalNode node4 = factory.createNonterminalNode(A, 0, 7);
		IntermediateNode node5 = factory.createIntermediateNode(list(B, A), 0, 6);
		NonterminalNode node6 = factory.createNonterminalNode(B, 0, 0);
		NonterminalNode node7 = factory.createNonterminalNode(A, 0, 6);
		IntermediateNode node8 = factory.createIntermediateNode(list(B, A), 0, 5);
		NonterminalNode node9 = factory.createNonterminalNode(A, 0, 5);
		IntermediateNode node10 = factory.createIntermediateNode(list(D, A), 0, 4);
		NonterminalNode node11 = factory.createNonterminalNode(A, 0, 4);
		IntermediateNode node12 = factory.createIntermediateNode(list(B, A), 0, 3);
		NonterminalNode node13 = factory.createNonterminalNode(A, 0, 3);
		IntermediateNode node14 = factory.createIntermediateNode(list(D, A), 0, 2);
		NonterminalNode node15 = factory.createNonterminalNode(A, 0, 2);
		IntermediateNode node16 = factory.createIntermediateNode(list(B, A), 0, 1);
		NonterminalNode node17 = factory.createNonterminalNode(A, 0, 1);
	...
	private SPPFNode getSPPFNode4() {
		...
		NonterminalNode node6 = factory.createNonterminalNode(A, 0, 6);
		IntermediateNode node7 = factory.createIntermediateNode(list(D, A), 0, 5);
		NonterminalNode node8 = factory.createNonterminalNode(A, 0, 5);
		IntermediateNode node9 = factory.createIntermediateNode(list(D, A), 0, 4);
		NonterminalNode node10 = factory.createNonterminalNode(A, 0, 4);
		IntermediateNode node11 = factory.createIntermediateNode(list(D, A), 0, 3);
		NonterminalNode node12 = factory.createNonterminalNode(A, 0, 3);
		IntermediateNode node13 = factory.createIntermediateNode(list(B, A), 0, 2);
		NonterminalNode node14 = factory.createNonterminalNode(B, 0, 1);
		TokenSymbolNode node15 = factory.createTokenNode(x, 0, 1);
		node14.addChild(node15);
		NonterminalNode node16 = factory.createNonterminalNode(A, 1, 2);
	...
	private SPPFNode getSPPFNode5() {
		GrammarGraph grammarGraph = grammar.toGrammarGraph();
		SPPFNodeFactory factory = new SPPFNodeFactory(grammarGraph);
		NonterminalNode node1 = factory.createNonterminalNode(A, 0, 11);
		...
		NonterminalNode node4 = factory.createNonterminalNode(A, 0, 10);
		IntermediateNode node5 = factory.createIntermediateNode(list(B, A), 0, 9);
		NonterminalNode node6 = factory.createNonterminalNode(A, 0, 9);
		IntermediateNode node7 = factory.createIntermediateNode(list(B, A), 0, 8);
		NonterminalNode node8 = factory.createNonterminalNode(A, 0, 8);
		IntermediateNode node9 = factory.createIntermediateNode(list(B, A), 0, 7);
		NonterminalNode node10 = factory.createNonterminalNode(A, 0, 7);
		IntermediateNode node11 = factory.createIntermediateNode(list(D, A), 0, 6);
		NonterminalNode node12 = factory.createNonterminalNode(D, 0, 1);
		TokenSymbolNode node13 = factory.createTokenNode(y, 0, 1);
		node12.addChild(node13);
		NonterminalNode node14 = factory.createNonterminalNode(A, 1, 6);
		IntermediateNode node15 = factory.createIntermediateNode(list(B, A), 1, 5);
		NonterminalNode node16 = factory.createNonterminalNode(B, 1, 1);
		NonterminalNode node17 = factory.createNonterminalNode(A, 1, 5);
		IntermediateNode node18 = factory.createIntermediateNode(list(B, A), 1, 4);
		NonterminalNode node19 = factory.createNonterminalNode(A, 1, 4);
		IntermediateNode node20 = factory.createIntermediateNode(list(B, A), 1, 3);
		NonterminalNode node21 = factory.createNonterminalNode(A, 1, 3);
		IntermediateNode node22 = factory.createIntermediateNode(list(B, A), 1, 2);
		NonterminalNode node23 = factory.createNonterminalNode(A, 1, 2);
