...
//		assertTrue(result.asParseSuccess().getRoot().deepEquals(getSPPF()));
	...
	private NonterminalNode getSPPF() {
		...
		TerminalSymbolNode node13 = factory.createTokenNode("a", 0, 1);
		...
		TerminalSymbolNode node29 = factory.createTokenNode("a", 4, 1);
		...
		TerminalSymbolNode node43 = factory.createTokenNode("a", 6, 1);
		...
		TerminalSymbolNode node46 = factory.createTokenNode("a", 7, 1);
		...
		TerminalSymbolNode node64 = factory.createTokenNode("a", 11, 1);
		...
		TerminalSymbolNode node67 = factory.createTokenNode("a", 12, 1);
		...
		TerminalSymbolNode node70 = factory.createTokenNode("a", 13, 1);
