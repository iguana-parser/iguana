...
public class PrecedenceTest3 {
	...
	private NonterminalNode getSPPF(GrammarSlotRegistry registry) {
		...
		TerminalNode node29 = factory.createTerminalNode("a", 4, 1);
		...
		TerminalNode node43 = factory.createTerminalNode("a", 6, 1);
		...
		TerminalNode node46 = factory.createTerminalNode("a", 7, 1);
		...
		TerminalNode node64 = factory.createTerminalNode("a", 11, 1);
		...
		TerminalNode node67 = factory.createTerminalNode("a", 12, 1);
		...
		TerminalNode node70 = factory.createTerminalNode("a", 13, 1);
