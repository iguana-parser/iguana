...
public class FilterTest2 {
	...
	private SPPFNode getSPPF() {
		...
		NonterminalSymbolNode node6 = factory.createNonterminalNode(E, 2, 10);
		...
		NonterminalSymbolNode node11 = factory.createNonterminalNode(E, 4, 10);
		IntermediateNode node12 = factory.createIntermediateNode(list(E, hat), 4, 6);
		NonterminalSymbolNode node13 = factory.createNonterminalNode(E, 4, 5);
		...
		NonterminalSymbolNode node16 = factory.createNonterminalNode(E, 6, 10);
		TokenSymbolNode node17 = factory.createTokenNode(minus, 6, 1);
		NonterminalSymbolNode node18 = factory.createNonterminalNode(E, 7, 10);
		IntermediateNode node19 = factory.createIntermediateNode(list(E, plus), 7, 9);
		NonterminalSymbolNode node20 = factory.createNonterminalNode(E, 7, 8);
		...
		NonterminalSymbolNode node23 = factory.createNonterminalNode(E, 9, 10);
