...
public class PrecedenceTest2 {
	...
	private SPPFNode getSPPF() {
		...
		TerminalSymbolNode node8 = factory.createTokenNode("+", 1, 1);
		...
		TerminalSymbolNode node23 = factory.createTokenNode("a", 4, 1);
		node22.addChild(node23);
		node21.addChild(node22);
		TerminalSymbolNode node24 = factory.createTokenNode("^", 5, 1);
		...
		TerminalSymbolNode node34 = factory.createTokenNode("a", 7, 1);
		node33.addChild(node34);
		node32.addChild(node33);
		TerminalSymbolNode node35 = factory.createTokenNode("+", 8, 1);
		...
		TerminalSymbolNode node38 = factory.createTokenNode("a", 9, 1);
