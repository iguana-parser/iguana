...
public class PrecedenceTest2 {
	...
	private SPPFNode getSPPF(GrammarSlotRegistry registry) {
		...
		TerminalNode node23 = factory.createTerminalNode("a", 4, 1);
		node22.addChild(node23);
		node21.addChild(node22);
		TerminalNode node24 = factory.createTerminalNode("^", 5, 1);
		...
		TerminalNode node34 = factory.createTerminalNode("a", 7, 1);
		node33.addChild(node34);
		node32.addChild(node33);
		TerminalNode node35 = factory.createTerminalNode("+", 8, 1);
		...
		TerminalNode node38 = factory.createTerminalNode("a", 9, 1);
