...
public class PrecedenceTest7 {
	...
	private NonterminalNode getSPPF(GrammarSlotRegistry registry) {
		...
		TerminalNode node20 = factory.createTerminalNode("a", 1, 1);
		...
		TerminalNode node23 = factory.createTerminalNode("a", 2, 1);
		node22.addChild(node23);
		node21.addChild(node22);
		node10.addChild(node11);
		node10.addChild(node21);
		node9.addChild(node10);
		TerminalNode node24 = factory.createTerminalNode("+", 3, 1);
		...
		TerminalNode node35 = factory.createTerminalNode("a", 4, 1);
		...
		TerminalNode node38 = factory.createTerminalNode("a", 5, 1);
		...
		TerminalNode node44 = factory.createTerminalNode("a", 7, 1);
		...
		TerminalNode node45 = factory.createTerminalNode("+", 8, 1);
		...
		TerminalNode node56 = factory.createTerminalNode("a", 9, 1);
		...
		TerminalNode node59 = factory.createTerminalNode("a", 10, 1);
		...
		TerminalNode node62 = factory.createTerminalNode("a", 11, 1);
		...
		TerminalNode node65 = factory.createTerminalNode("a", 12, 1);
