...
public class PrecedenceTest7 {
	...
	private NonterminalNode getSPPF() {
		...
		TerminalNode node17 = factory.createTokenNode("a", 0, 1);
		...
		TerminalNode node35 = factory.createTokenNode("a", 4, 1);
		...
		TerminalNode node38 = factory.createTokenNode("a", 5, 1);
		...
		TerminalNode node41 = factory.createTokenNode("a", 6, 1);
		...
		TerminalNode node44 = factory.createTokenNode("a", 7, 1);
		...
		TerminalNode node45 = factory.createTokenNode("+", 8, 1);
		...
		TerminalNode node56 = factory.createTokenNode("a", 9, 1);
		...
		TerminalNode node59 = factory.createTokenNode("a", 10, 1);
		...
		TerminalNode node62 = factory.createTokenNode("a", 11, 1);
		...
		TerminalNode node65 = factory.createTokenNode("a", 12, 1);
