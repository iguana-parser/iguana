...
public class PrecedenceTest7 {
	...
	private NonterminalNode getSPPF() {
		...
		NonterminalNode node1 = factory.createNonterminalNode("E", 0, 0, 13).init();
		...
		NonterminalNode node5 = factory.createNonterminalNode("E", 0, 0, 8).init();
		...
		ListSymbolNode node11 = factory.createListNode("EPlus", 1, 0, 2).init();
		PackedNode node12 = factory.createPackedNode("EPlus1 ::= EPlus1 E3 .", 1, node11);
		ListSymbolNode node13 = factory.createListNode("EPlus", 1, 0, 1).init();
		PackedNode node14 = factory.createPackedNode("EPlus1 ::= E3 .", 0, node13);
		NonterminalNode node15 = factory.createNonterminalNode("E", 3, 0, 1).init();
		...
		NonterminalNode node25 = factory.createNonterminalNode("E", 2, 4, 8).init();
		PackedNode node26 = factory.createPackedNode("E2 ::= EPlus1 E1 .", 7, node25);
		ListSymbolNode node27 = factory.createListNode("EPlus", 1, 4, 7).init();
		PackedNode node28 = factory.createPackedNode("EPlus1 ::= EPlus1 E3 .", 6, node27);
		ListSymbolNode node29 = factory.createListNode("EPlus", 1, 4, 6).init();
		PackedNode node30 = factory.createPackedNode("EPlus1 ::= EPlus1 E3 .", 5, node29);
		ListSymbolNode node31 = factory.createListNode("EPlus", 1, 4, 5).init();
		PackedNode node32 = factory.createPackedNode("EPlus1 ::= E3 .", 4, node31);
		NonterminalNode node33 = factory.createNonterminalNode("E", 3, 4, 5).init();
		...
		NonterminalNode node36 = factory.createNonterminalNode("E", 3, 5, 6).init();
		...
		NonterminalNode node39 = factory.createNonterminalNode("E", 3, 6, 7).init();
		...
		NonterminalNode node42 = factory.createNonterminalNode("E", 1, 7, 8).init();
		...
		NonterminalNode node46 = factory.createNonterminalNode("E", 2, 9, 13).init();
		PackedNode node47 = factory.createPackedNode("E2 ::= EPlus1 E1 .", 12, node46);
		ListSymbolNode node48 = factory.createListNode("EPlus", 1, 9, 12).init();
		PackedNode node49 = factory.createPackedNode("EPlus1 ::= EPlus1 E3 .", 11, node48);
		ListSymbolNode node50 = factory.createListNode("EPlus", 1, 9, 11).init();
		PackedNode node51 = factory.createPackedNode("EPlus1 ::= EPlus1 E3 .", 10, node50);
		ListSymbolNode node52 = factory.createListNode("EPlus", 1, 9, 10).init();
		PackedNode node53 = factory.createPackedNode("EPlus1 ::= E3 .", 9, node52);
		NonterminalNode node54 = factory.createNonterminalNode("E", 3, 9, 10).init();
		...
		NonterminalNode node57 = factory.createNonterminalNode("E", 3, 10, 11).init();
		...
		NonterminalNode node60 = factory.createNonterminalNode("E", 3, 11, 12).init();
		...
		NonterminalNode node63 = factory.createNonterminalNode("E", 1, 12, 13).init();
