...
public class PrecedenceTest7 {
	...
	private NonterminalNode getSPPF() {
		...
		TerminalSymbolNode node17 = factory.createTokenNode("a", 0, 1);
		...
		TerminalSymbolNode node20 = factory.createTokenNode("a", 1, 1);
		...
		TerminalSymbolNode node23 = factory.createTokenNode("a", 2, 1);
		...
		ListSymbolNode node27 = factory.createListNode("EPlus", 2, 4, 7).init();
		PackedNode node28 = factory.createPackedNode("EPlus2 ::= EPlus2 E3 .", 6, node27);
		ListSymbolNode node29 = factory.createListNode("EPlus", 2, 4, 6).init();
		PackedNode node30 = factory.createPackedNode("EPlus2 ::= EPlus2 E3 .", 5, node29);
		ListSymbolNode node31 = factory.createListNode("EPlus", 2, 4, 5).init();
		...
		TerminalSymbolNode node35 = factory.createTokenNode("a", 4, 1);
		...
		TerminalSymbolNode node38 = factory.createTokenNode("a", 5, 1);
		...
		TerminalSymbolNode node41 = factory.createTokenNode("a", 6, 1);
		...
		TerminalSymbolNode node44 = factory.createTokenNode("a", 7, 1);
		...
		TerminalSymbolNode node45 = factory.createTokenNode("+", 8, 1);
		...
		ListSymbolNode node48 = factory.createListNode("EPlus", 2, 9, 12).init();
		PackedNode node49 = factory.createPackedNode("EPlus2 ::= EPlus2 E3 .", 11, node48);
		ListSymbolNode node50 = factory.createListNode("EPlus", 2, 9, 11).init();
		PackedNode node51 = factory.createPackedNode("EPlus2 ::= EPlus2 E3 .", 10, node50);
		ListSymbolNode node52 = factory.createListNode("EPlus", 2, 9, 10).init();
		...
		TerminalSymbolNode node56 = factory.createTokenNode("a", 9, 1);
		...
		TerminalSymbolNode node59 = factory.createTokenNode("a", 10, 1);
		...
		TerminalSymbolNode node62 = factory.createTokenNode("a", 11, 1);
		...
		TerminalSymbolNode node65 = factory.createTokenNode("a", 12, 1);
