...
public class FilterTest8 {
	...
	private SPPFNode getSPPF1() {
		...
		NonterminalSymbolNode node6 = factory.createNonterminalNode(E, 2, 8);
		...
		NonterminalSymbolNode node9 = factory.createNonterminalNode(E, 2, 3);
		...
		NonterminalSymbolNode node12 = factory.createNonterminalNode(E, 4, 7);
		IntermediateNode node13 = factory.createIntermediateNode(list(E, plus), 4, 6);
		NonterminalSymbolNode node14 = factory.createNonterminalNode(E, 4, 5);
		...
		NonterminalSymbolNode node17 = factory.createNonterminalNode(E, 6, 7);
