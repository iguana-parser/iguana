...
public class PrecedenceTest8 {
	...
	private SPPFNode getSPPF1() {
		...
		TerminalSymbolNode node17 = factory.createTokenNode("a", 2, 1);
		node16.addChild(node17);
		node15.addChild(node16);
		TerminalSymbolNode node18 = factory.createTokenNode("[", 3, 1);
		...
		TerminalSymbolNode node25 = factory.createTokenNode("a", 4, 1);
		node24.addChild(node25);
		node23.addChild(node24);
		TerminalSymbolNode node26 = factory.createTokenNode("+", 5, 1);
		...
		TerminalSymbolNode node29 = factory.createTokenNode("a", 6, 1);
