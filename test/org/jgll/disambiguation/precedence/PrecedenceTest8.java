...
public class PrecedenceTest8 {
	...
	private SPPFNode getSPPF1() {
		...
		TerminalNode node17 = factory.createTokenNode("a", 2, 1);
		node16.addChild(node17);
		node15.addChild(node16);
		TerminalNode node18 = factory.createTokenNode("[", 3, 1);
		...
		TerminalNode node25 = factory.createTokenNode("a", 4, 1);
		node24.addChild(node25);
		node23.addChild(node24);
		TerminalNode node26 = factory.createTokenNode("+", 5, 1);
		...
		TerminalNode node29 = factory.createTokenNode("a", 6, 1);
