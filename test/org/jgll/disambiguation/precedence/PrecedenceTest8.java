...
public class PrecedenceTest8 {
	...
	private SPPFNode getSPPF1(GrammarSlotRegistry registry) {
		...
		TerminalNode node17 = factory.createTerminalNode("a", 2, 1);
		node16.addChild(node17);
		node15.addChild(node16);
		TerminalNode node18 = factory.createTerminalNode("[", 3, 1);
		...
		TerminalNode node25 = factory.createTerminalNode("a", 4, 1);
		node24.addChild(node25);
		node23.addChild(node24);
		TerminalNode node26 = factory.createTerminalNode("+", 5, 1);
		...
		TerminalNode node29 = factory.createTerminalNode("a", 6, 1);
