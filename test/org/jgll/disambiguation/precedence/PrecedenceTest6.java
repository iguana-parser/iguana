...
public class PrecedenceTest6 {
	...
	private SPPFNode getSPPF(GrammarSlotRegistry registry) {
		...
		TerminalNode node12 = factory.createTerminalNode("+", 1, 1);
		...
		TerminalNode node26 = factory.createTerminalNode("a", 5, 1);
		node25.addChild(node26);
		node24.addChild(node25);
		TerminalNode node27 = factory.createTerminalNode("+", 6, 1);
		...
		TerminalNode node30 = factory.createTerminalNode("-", 7, 1);
		...
		TerminalNode node49 = factory.createTerminalNode("a", 8, 1);
		node48.addChild(node49);
		node47.addChild(node48);
		TerminalNode node50 = factory.createTerminalNode("+", 9, 1);
		...
		TerminalNode node65 = factory.createTerminalNode("a", 16, 1);
