...
public class PrecedenceTest6 {
	...
	private SPPFNode getSPPF(GrammarSlotRegistry registry) {
		...
		TerminalNode node11 = factory.createTokenNode("a", 0, 1);
		node10.addChild(node11);
		node9.addChild(node10);
		TerminalNode node12 = factory.createTokenNode("+", 1, 1);
		...
		TerminalNode node16 = factory.createTokenNode("-", 3, 1);
		...
		TerminalNode node26 = factory.createTokenNode("a", 5, 1);
		node25.addChild(node26);
		node24.addChild(node25);
		TerminalNode node27 = factory.createTokenNode("+", 6, 1);
		...
		TerminalNode node30 = factory.createTokenNode("-", 7, 1);
		...
		TerminalNode node65 = factory.createTokenNode("a", 16, 1);
