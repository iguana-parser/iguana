...
public class FilterTest3 {
	...
	private NonterminalSymbolNode getSPPF() {
		...
		NonterminalSymbolNode node1 = factory.createNonterminalNode(E, 0, 14);
		IntermediateNode node2 = factory.createIntermediateNode(list(E, plus), 0, 10);
		NonterminalSymbolNode node3 = factory.createNonterminalNode(E, 0, 9);
		...
		NonterminalSymbolNode node6 = factory.createNonterminalNode(E, 0, 1);
		...
		NonterminalSymbolNode node15 = factory.createNonterminalNode(E, 4, 9);
		NonterminalSymbolNode node16 = factory.createNonterminalNode(E, 4, 5);
		...
		NonterminalSymbolNode node22 = factory.createNonterminalNode(E, 5, 6);
		TokenSymbolNode node23 = factory.createTokenNode(a, 5, 1);
		node22.addChild(node23);
		node21.addChild(node22);
		NonterminalSymbolNode node24 = factory.createNonterminalNode(E, 6, 7);
		TokenSymbolNode node25 = factory.createTokenNode(a, 6, 1);
		node24.addChild(node25);
		node20.addChild(node21);
		node20.addChild(node24);
		NonterminalSymbolNode node26 = factory.createNonterminalNode(E, 7, 8);
		...
		NonterminalSymbolNode node31 = factory.createNonterminalNode(E, 10, 14);
		NonterminalSymbolNode node32 = factory.createNonterminalNode(E, 10, 11);
