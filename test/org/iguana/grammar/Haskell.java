...
public class Haskell {
	...
	public static Grammar grammar =
		...
		// Stmt ::= Qual? (;) 
		.addRule(Rule.withHead(Nonterminal.builder("Stmt").build()).addSymbol(org.iguana.regex.Opt.builder(Nonterminal.builder("Qual").build()).build()).addSymbol(Terminal.builder(Sequence.builder(Character.builder(59).build()).build()).build()).build())
		...
		// FExp ::= FExp? AExp 
		.addRule(Rule.withHead(Nonterminal.builder("FExp").build()).addSymbol(org.iguana.regex.Opt.builder(Nonterminal.builder("FExp").build()).build()).addSymbol(Nonterminal.builder("AExp").build()).build())
		// QTyCls ::= (ModId (.))? TyCls 
		.addRule(Rule.withHead(Nonterminal.builder("QTyCls").build()).addSymbol(org.iguana.regex.Opt.builder(Sequence.builder(Nonterminal.builder("ModId").build(), Terminal.builder(Sequence.builder(Character.builder(46).build()).build()).build()).build()).build()).addSymbol(Nonterminal.builder("TyCls").build()).setLayoutStrategy(NO_LAYOUT).build())
		// Decimal ::= Digit Digit* 
		...
		.addRule(Rule.withHead(Nonterminal.builder("ImpDecls").build()).addSymbol(Nonterminal.builder("ImpDecl").build()).addSymbol(Star.builder(Sequence.builder(Terminal.builder(Sequence.builder(Character.builder(59).build()).build()).build(), org.iguana.regex.Opt.builder(Nonterminal.builder("ImpDecl").build()).build()).build()).build()).build())
		// Space ::= (\u0020) 
		...
		.addRule(Rule.withHead(Nonterminal.builder("ImpDecl").build()).addSymbol(Terminal.builder(Sequence.builder(Character.builder(105).build(), Character.builder(109).build(), Character.builder(112).build(), Character.builder(111).build(), Character.builder(114).build(), Character.builder(116).build()).build()).build()).addSymbol(org.iguana.regex.Opt.builder(Terminal.builder(Sequence.builder(Character.builder(113).build(), Character.builder(117).build(), Character.builder(97).build(), Character.builder(108).build(), Character.builder(105).build(), Character.builder(102).build(), Character.builder(105).build(), Character.builder(101).build(), Character.builder(100).build()).build()).build()).build()).addSymbol(Nonterminal.builder("ModId").build()).addSymbol(org.iguana.regex.Opt.builder(Sequence.builder(Terminal.builder(Sequence.builder(Character.builder(97).build(), Character.builder(115).build()).build()).build(), Nonterminal.builder("ModId").build()).build()).build()).addSymbol(org.iguana.regex.Opt.builder(Nonterminal.builder("ImpSpec").build()).build()).build())
		// Exp ::= InfixExp1 (: :) CType 
		...
		// AExp ::= ([) Exp ((,) Exp)? (. .) Exp? (]) 
		.addRule(Rule.withHead(Nonterminal.builder("AExp").build()).addSymbol(Terminal.builder(Sequence.builder(Character.builder(91).build()).build()).build()).addSymbol(Nonterminal.builder("Exp").build()).addSymbol(org.iguana.regex.Opt.builder(Sequence.builder(Terminal.builder(Sequence.builder(Character.builder(44).build()).build()).build(), Nonterminal.builder("Exp").build()).build()).build()).addSymbol(Terminal.builder(Sequence.builder(Character.builder(46).build(), Character.builder(46).build()).build()).build()).addSymbol(org.iguana.regex.Opt.builder(Nonterminal.builder("Exp").build()).build()).addSymbol(Terminal.builder(Sequence.builder(Character.builder(93).build()).build()).build()).build())
		// AExp ::= (() InfixExp QOp ()) 
		...
		.addRule(Rule.withHead(Nonterminal.builder("Exponent").build()).addSymbol(Alt.builder(CharacterRange.builder(69, 69).build(), CharacterRange.builder(101, 101).build()).build()).addSymbol(org.iguana.regex.Opt.builder(Alt.builder(CharacterRange.builder(43, 43).build(), CharacterRange.builder(45, 45).build()).build()).build()).addSymbol(Nonterminal.builder("Decimal").build()).setLayoutStrategy(NO_LAYOUT).build())
		...
		.addRule(Rule.withHead(Nonterminal.builder("Float").build()).addSymbol(Nonterminal.builder("Decimal").build()).addSymbol(Terminal.builder(Sequence.builder(Character.builder(46).build()).build()).build()).addSymbol(Nonterminal.builder("Decimal").build()).addSymbol(org.iguana.regex.Opt.builder(Nonterminal.builder("Exponent").build()).build()).setLayoutStrategy(NO_LAYOUT).build())
		// ConSym ::= ((:) Symbol+) 
		...
		.addRule(Rule.withHead(Nonterminal.builder("LExp").build()).addSymbol(Terminal.builder(Sequence.builder(Character.builder(105).build(), Character.builder(102).build()).build()).build()).addSymbol(Nonterminal.builder("Exp").build()).addSymbol(org.iguana.regex.Opt.builder(Terminal.builder(Sequence.builder(Character.builder(59).build()).build()).build()).build()).addSymbol(Terminal.builder(Sequence.builder(Character.builder(116).build(), Character.builder(104).build(), Character.builder(101).build(), Character.builder(110).build()).build()).build()).addSymbol(Nonterminal.builder("Exp").build()).addSymbol(org.iguana.regex.Opt.builder(Terminal.builder(Sequence.builder(Character.builder(59).build()).build()).build()).build()).addSymbol(Terminal.builder(Sequence.builder(Character.builder(101).build(), Character.builder(108).build(), Character.builder(115).build(), Character.builder(101).build()).build()).build()).addSymbol(Nonterminal.builder("Exp").build()).build())
		// LExp ::= (\) APat+ (- >) Exp 
		...
		// QConId ::= (ModId (.))? ConId 
		.addRule(Rule.withHead(Nonterminal.builder("QConId").build()).addSymbol(org.iguana.regex.Opt.builder(Sequence.builder(Nonterminal.builder("ModId").build(), Terminal.builder(Sequence.builder(Character.builder(46).build()).build()).build()).build()).build()).addSymbol(Nonterminal.builder("ConId").build()).setLayoutStrategy(NO_LAYOUT).build())
		...
		// QTyCon ::= (ModId (.))? TyCon 
		.addRule(Rule.withHead(Nonterminal.builder("QTyCon").build()).addSymbol(org.iguana.regex.Opt.builder(Sequence.builder(Nonterminal.builder("ModId").build(), Terminal.builder(Sequence.builder(Character.builder(46).build()).build()).build()).build()).build()).addSymbol(Nonterminal.builder("TyCon").build()).setLayoutStrategy(NO_LAYOUT).build())
		// Stmts ::= Stmt* Exp (;)? 
		.addRule(Rule.withHead(Nonterminal.builder("Stmts").build()).addSymbol(Star.builder(Nonterminal.builder("Stmt").build()).build()).addSymbol(Nonterminal.builder("Exp").build()).addSymbol(org.iguana.regex.Opt.builder(Terminal.builder(Sequence.builder(Character.builder(59).build()).build()).build()).build()).build())
		// OctIt ::= (0-7) 
		...
		.addRule(Rule.withHead(Nonterminal.builder("FDecl").build()).addSymbol(Terminal.builder(Sequence.builder(Character.builder(105).build(), Character.builder(109).build(), Character.builder(112).build(), Character.builder(111).build(), Character.builder(114).build(), Character.builder(116).build()).build()).build()).addSymbol(Nonterminal.builder("CallConv").build()).addSymbol(org.iguana.regex.Opt.builder(Nonterminal.builder("Safety").build()).build()).addSymbol(Nonterminal.builder("Impent").build()).addSymbol(Nonterminal.builder("Var").build()).addSymbol(Terminal.builder(Sequence.builder(Character.builder(58).build(), Character.builder(58).build()).build()).build()).addSymbol(Nonterminal.builder("FType").build()).build())
		...
		.addRule(Rule.withHead(Nonterminal.builder("Module").build()).addSymbol(Terminal.builder(Sequence.builder(Character.builder(109).build(), Character.builder(111).build(), Character.builder(100).build(), Character.builder(117).build(), Character.builder(108).build(), Character.builder(101).build()).build()).build()).addSymbol(Nonterminal.builder("ModId").build()).addSymbol(org.iguana.regex.Opt.builder(Nonterminal.builder("Exports").build()).build()).addSymbol(Terminal.builder(Sequence.builder(Character.builder(119).build(), Character.builder(104).build(), Character.builder(101).build(), Character.builder(114).build(), Character.builder(101).build()).build()).build()).addSymbol(Nonterminal.builder("Body").build()).build())
		// Integer ::= (0 O) Octal 
		...
		.addRule(Rule.withHead(Nonterminal.builder("Import").build()).addSymbol(Nonterminal.builder("ConId").build()).addSymbol(org.iguana.regex.Opt.builder(Alt.builder(Sequence.builder(Terminal.builder(Sequence.builder(Character.builder(40).build()).build()).build(), Terminal.builder(Sequence.builder(Character.builder(46).build(), Character.builder(46).build()).build()).build(), Terminal.builder(Sequence.builder(Character.builder(41).build()).build()).build()).build(), Sequence.builder(Terminal.builder(Sequence.builder(Character.builder(40).build()).build()).build(), Star.builder(Alt.builder(Nonterminal.builder("QVar").build(), Nonterminal.builder("Con").build()).build()).addSeparators(Arrays.asList(Terminal.builder(Sequence.builder(Character.builder(44).build()).build()).build())).build(), Terminal.builder(Sequence.builder(Character.builder(41).build()).build()).build()).build()).build()).build()).build())
		// Import ::= Var 
		...
		.addRule(Rule.withHead(Nonterminal.builder("RHS").build()).addSymbol(Nonterminal.builder("GDRHS").build()).addSymbol(org.iguana.regex.Opt.builder(Sequence.builder(Terminal.builder(Sequence.builder(Character.builder(119).build(), Character.builder(104).build(), Character.builder(101).build(), Character.builder(114).build(), Character.builder(101).build()).build()).build(), Nonterminal.builder("Decls").build()).build()).build()).build())
		// RHS ::= (=) Exp ((w h e r e) Decls)? 
		.addRule(Rule.withHead(Nonterminal.builder("RHS").build()).addSymbol(Terminal.builder(Sequence.builder(Character.builder(61).build()).build()).build()).addSymbol(Nonterminal.builder("Exp").build()).addSymbol(org.iguana.regex.Opt.builder(Sequence.builder(Terminal.builder(Sequence.builder(Character.builder(119).build(), Character.builder(104).build(), Character.builder(101).build(), Character.builder(114).build(), Character.builder(101).build()).build()).build(), Nonterminal.builder("Decls").build()).build()).build()).build())
		// CallConv ::= (j v m) 
		...
		// FBind ::= QVar ((=) Exp)? 
		.addRule(Rule.withHead(Nonterminal.builder("FBind").build()).addSymbol(Nonterminal.builder("QVar").build()).addSymbol(org.iguana.regex.Opt.builder(Sequence.builder(Terminal.builder(Sequence.builder(Character.builder(61).build()).build()).build(), Nonterminal.builder("Exp").build()).build()).build()).build())
		// BType ::= BType? (!)? AType 
		.addRule(Rule.withHead(Nonterminal.builder("BType").build()).addSymbol(org.iguana.regex.Opt.builder(Nonterminal.builder("BType").build()).build()).addSymbol(org.iguana.regex.Opt.builder(Terminal.builder(Sequence.builder(Character.builder(33).build()).build()).build()).build()).addSymbol(Nonterminal.builder("AType").build()).build())
		...
		// Kind ::= AKind* ((- >) Kind)? 
		.addRule(Rule.withHead(Nonterminal.builder("Kind").build()).addSymbol(Star.builder(Nonterminal.builder("AKind").build()).build()).addSymbol(org.iguana.regex.Opt.builder(Sequence.builder(Terminal.builder(Sequence.builder(Character.builder(45).build(), Character.builder(62).build()).build()).build(), Nonterminal.builder("Kind").build()).build()).build()).build())
		// Decls ::= ({) Decl?+ (}) 
		.addRule(Rule.withHead(Nonterminal.builder("Decls").build()).addSymbol(Terminal.builder(Sequence.builder(Character.builder(123).build()).build()).build()).addSymbol(Plus.builder(org.iguana.regex.Opt.builder(Nonterminal.builder("Decl").build()).build()).addSeparators(Arrays.asList(Terminal.builder(Sequence.builder(Character.builder(59).build()).build()).build())).build()).addSymbol(Terminal.builder(Sequence.builder(Character.builder(125).build()).build()).build()).build())
		// FRType ::= FAType 
		...
		// APat ::= Var ((@) APat)? 
		.addRule(Rule.withHead(Nonterminal.builder("APat").build()).addSymbol(Nonterminal.builder("Var").build()).addSymbol(org.iguana.regex.Opt.builder(Sequence.builder(Terminal.builder(Sequence.builder(Character.builder(64).build()).build()).build(), Nonterminal.builder("APat").build()).build()).build()).build())
		// APat ::= (() ((_) | Var) (: :) CType ()) 
		...
		.addRule(Rule.withHead(Nonterminal.builder("QConSym").build()).addSymbol(org.iguana.regex.Opt.builder(Sequence.builder(Nonterminal.builder("ModId").build(), Terminal.builder(Sequence.builder(Character.builder(46).build()).build()).build()).build()).build()).addSymbol(Nonterminal.builder("ConSym").build()).setLayoutStrategy(NO_LAYOUT).build())
		// Literal ::= Char 
		...
		.addRule(Rule.withHead(Nonterminal.builder("TopDecls").build()).addSymbol(Nonterminal.builder("TopDecl").build()).addSymbol(Star.builder(Sequence.builder(Terminal.builder(Sequence.builder(Character.builder(59).build()).build()).build(), org.iguana.regex.Opt.builder(Nonterminal.builder("TopDecl").build()).build()).build()).build()).build())
		// QVar ::= (() QVarSym ()) 
		...
		// Expent ::= String? 
		.addRule(Rule.withHead(Nonterminal.builder("Expent").build()).addSymbol(org.iguana.regex.Opt.builder(Nonterminal.builder("String").build()).build()).build())
		...
		.addRule(Rule.withHead(Nonterminal.builder("TopDecl").build()).addSymbol(Terminal.builder(Sequence.builder(Character.builder(99).build(), Character.builder(108).build(), Character.builder(97).build(), Character.builder(115).build(), Character.builder(115).build()).build()).build()).addSymbol(org.iguana.regex.Opt.builder(Sequence.builder(Nonterminal.builder("Context").build(), Terminal.builder(Sequence.builder(Character.builder(61).build(), Character.builder(62).build()).build()).build()).build()).build()).addSymbol(Nonterminal.builder("Type").build()).addSymbol(org.iguana.regex.Opt.builder(Nonterminal.builder("Fds").build()).build()).addSymbol(org.iguana.regex.Opt.builder(Sequence.builder(Terminal.builder(Sequence.builder(Character.builder(119).build(), Character.builder(104).build(), Character.builder(101).build(), Character.builder(114).build(), Character.builder(101).build()).build()).build(), Nonterminal.builder("CDecls").build()).build()).build()).build())
		// TopDecl ::= (n e w t y p e) (Context (= >))? Type (=) NewConstr Deriving? 
		.addRule(Rule.withHead(Nonterminal.builder("TopDecl").build()).addSymbol(Terminal.builder(Sequence.builder(Character.builder(110).build(), Character.builder(101).build(), Character.builder(119).build(), Character.builder(116).build(), Character.builder(121).build(), Character.builder(112).build(), Character.builder(101).build()).build()).build()).addSymbol(org.iguana.regex.Opt.builder(Sequence.builder(Nonterminal.builder("Context").build(), Terminal.builder(Sequence.builder(Character.builder(61).build(), Character.builder(62).build()).build()).build()).build()).build()).addSymbol(Nonterminal.builder("Type").build()).addSymbol(Terminal.builder(Sequence.builder(Character.builder(61).build()).build()).build()).addSymbol(Nonterminal.builder("NewConstr").build()).addSymbol(org.iguana.regex.Opt.builder(Nonterminal.builder("Deriving").build()).build()).build())
		// TopDecl ::= Decl 
		...
		.addRule(Rule.withHead(Nonterminal.builder("TopDecl").build()).addSymbol(Terminal.builder(Sequence.builder(Character.builder(100).build(), Character.builder(97).build(), Character.builder(116).build(), Character.builder(97).build()).build()).build()).addSymbol(org.iguana.regex.Opt.builder(Sequence.builder(Nonterminal.builder("Context").build(), Terminal.builder(Sequence.builder(Character.builder(61).build(), Character.builder(62).build()).build()).build()).build()).build()).addSymbol(Nonterminal.builder("Type").build()).addSymbol(org.iguana.regex.Opt.builder(Sequence.builder(Terminal.builder(Sequence.builder(Character.builder(61).build()).build()).build(), Nonterminal.builder("Constrs").build()).build()).build()).addSymbol(org.iguana.regex.Opt.builder(Nonterminal.builder("Deriving").build()).build()).build())
		...
		.addRule(Rule.withHead(Nonterminal.builder("TopDecl").build()).addSymbol(Terminal.builder(Sequence.builder(Character.builder(105).build(), Character.builder(110).build(), Character.builder(115).build(), Character.builder(116).build(), Character.builder(97).build(), Character.builder(110).build(), Character.builder(99).build(), Character.builder(101).build()).build()).build()).addSymbol(Nonterminal.builder("CType").build()).addSymbol(org.iguana.regex.Opt.builder(Sequence.builder(Terminal.builder(Sequence.builder(Character.builder(119).build(), Character.builder(104).build(), Character.builder(101).build(), Character.builder(114).build(), Character.builder(101).build()).build()).build(), Nonterminal.builder("CDecls").build()).build()).build()).build())
		// TopDecl ::= (d e r i v i n g) (i n s t a n c e) (Context (= >))? QTyCls Inst 
		.addRule(Rule.withHead(Nonterminal.builder("TopDecl").build()).addSymbol(Terminal.builder(Sequence.builder(Character.builder(100).build(), Character.builder(101).build(), Character.builder(114).build(), Character.builder(105).build(), Character.builder(118).build(), Character.builder(105).build(), Character.builder(110).build(), Character.builder(103).build()).build()).build()).addSymbol(Terminal.builder(Sequence.builder(Character.builder(105).build(), Character.builder(110).build(), Character.builder(115).build(), Character.builder(116).build(), Character.builder(97).build(), Character.builder(110).build(), Character.builder(99).build(), Character.builder(101).build()).build()).build()).addSymbol(org.iguana.regex.Opt.builder(Sequence.builder(Nonterminal.builder("Context").build(), Terminal.builder(Sequence.builder(Character.builder(61).build(), Character.builder(62).build()).build()).build()).build()).build()).addSymbol(Nonterminal.builder("QTyCls").build()).addSymbol(Nonterminal.builder("Inst").build()).build())
		// TopDecl ::= InfixExp 
		...
		// Impent ::= String? 
		.addRule(Rule.withHead(Nonterminal.builder("Impent").build()).addSymbol(org.iguana.regex.Opt.builder(Nonterminal.builder("String").build()).build()).build())
		// FunLHS ::= (() FunLHS ()) APat+ 
		...
		.addRule(Rule.withHead(Nonterminal.builder("FunLHS").build()).addSymbol(Nonterminal.builder("Pat").build()).addSymbol(org.iguana.regex.Opt.builder(Sequence.builder(Nonterminal.builder("VarOp").addPostConditions(Sets.newHashSet(new RegularExpressionCondition(ConditionType.NOT_MATCH, Alt.builder(Terminal.builder(Sequence.builder(Character.builder(33).build()).build()).build()).build()))).build(), Nonterminal.builder("Pat").build()).build()).build()).build())
		// FunLHS ::= Var APat+ 
		...
		// FPat ::= QVar ((=) Pat)? 
		.addRule(Rule.withHead(Nonterminal.builder("FPat").build()).addSymbol(Nonterminal.builder("QVar").build()).addSymbol(org.iguana.regex.Opt.builder(Sequence.builder(Terminal.builder(Sequence.builder(Character.builder(61).build()).build()).build(), Nonterminal.builder("Pat").build()).build()).build()).build())
		// TyCon ::= ConId 
		...
		.addRule(Rule.withHead(Nonterminal.builder("GenDecl").build()).addSymbol(Nonterminal.builder("Fixity").build()).addSymbol(org.iguana.regex.Opt.builder(Nonterminal.builder("Integer").build()).build()).addSymbol(Nonterminal.builder("Ops").build()).build())
		// GDRHS ::= Guards (=) Exp GDRHS? 
		.addRule(Rule.withHead(Nonterminal.builder("GDRHS").build()).addSymbol(Nonterminal.builder("Guards").build()).addSymbol(Terminal.builder(Sequence.builder(Character.builder(61).build()).build()).build()).addSymbol(Nonterminal.builder("Exp").build()).addSymbol(org.iguana.regex.Opt.builder(Nonterminal.builder("GDRHS").build()).build()).build())
		.build();
	}
