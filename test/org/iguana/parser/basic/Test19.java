...
public class Test19 {
    ...
    private NonterminalNode expectedSPPF2(GrammarGraph registry) {
        ...
        TerminalNode node4 = createTerminalNode(registry.getSlot("a"), 2, 3);
        NonterminalNode node5 = createNonterminalNode(registry.getSlot("E"), registry.getSlot("E ::= a ."), node4);
        TerminalNode node6 = createTerminalNode(registry.getSlot("*"), 3, 4);
        IntermediateNode node7 = createIntermediateNode(registry.getSlot("E ::= E * . E"), node5, node6);
        TerminalNode node8 = createTerminalNode(registry.getSlot("a"), 4, 5);
        NonterminalNode node9 = createNonterminalNode(registry.getSlot("E"), registry.getSlot("E ::= a ."), node8);
        IntermediateNode node10 = createIntermediateNode(registry.getSlot("E ::= E * E ."), node7, node9);
        NonterminalNode node11 = createNonterminalNode(registry.getSlot("E"), registry.getSlot("E ::= E * E ."), node10);
        ...
        NonterminalNode node17 = createNonterminalNode(registry.getSlot("E"), registry.getSlot("E ::= E + E ."), node12);
    ...
    private NonterminalNode expectedSPPF3(GrammarGraph registry) {
        ...
        IntermediateNode node10 = createIntermediateNode(registry.getSlot("E ::= E * E ."), node7, node9);
        NonterminalNode node11 = createNonterminalNode(registry.getSlot("E"), registry.getSlot("E ::= E * E ."), node10);
        TerminalNode node12 = createTerminalNode(registry.getSlot("+"), 5, 6);
        IntermediateNode node13 = createIntermediateNode(registry.getSlot("E ::= E + . E"), node11, node12);
        TerminalNode node14 = createTerminalNode(registry.getSlot("a"), 6, 7);
        NonterminalNode node15 = createNonterminalNode(registry.getSlot("E"), registry.getSlot("E ::= a ."), node14);
        ...
        NonterminalNode node19 = createNonterminalNode(registry.getSlot("E"), registry.getSlot("E ::= E + E ."), node18);
        IntermediateNode node20 = createIntermediateNode(registry.getSlot("E ::= E * E ."), node7, node19);
        NonterminalNode node21 = createNonterminalNode(registry.getSlot("E"), registry.getSlot("E ::= E + E ."), node16);
        node21.addPackedNode(registry.getSlot("E ::= E * E ."), node20);
        TerminalNode node22 = createTerminalNode(registry.getSlot("*"), 7, 8);
        IntermediateNode node23 = createIntermediateNode(registry.getSlot("E ::= E * . E"), node21, node22);
        TerminalNode node24 = createTerminalNode(registry.getSlot("a"), 8, 9);
        NonterminalNode node25 = createNonterminalNode(registry.getSlot("E"), registry.getSlot("E ::= a ."), node24);
        ...
        NonterminalNode node32 = createNonterminalNode(registry.getSlot("E"), registry.getSlot("E ::= E + E ."), node29);
        ...
        NonterminalNode node35 = createNonterminalNode(registry.getSlot("E"), registry.getSlot("E ::= E * E ."), node33);
        ...
        NonterminalNode node41 = createNonterminalNode(registry.getSlot("E"), registry.getSlot("E ::= E + E ."), node36);
        ...
        NonterminalNode node46 = createNonterminalNode(registry.getSlot("E"), registry.getSlot("E ::= E + E ."), node44);
        ...
        NonterminalNode node49 = createNonterminalNode(registry.getSlot("E"), registry.getSlot("E ::= E + E ."), node43);
